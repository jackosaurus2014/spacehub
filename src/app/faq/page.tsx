...
const FAQ_ITEMS: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      'Yes! SpaceNexus offers a free Explorer tier that gives you access to core features including news feeds, basic mission tracking, and public data. Premium tiers (Professional and Enterprise) unlock advanced analytics, AI-powered insights, export capabilities, and priority support.',
  },
  {
    id: 'gen-4',
    category: 'general',
