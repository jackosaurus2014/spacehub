  ...
  return (
    <div className="min-h-screen bg-slate-950 p-4 sm:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto">
        {/* Title skeleton */}
        <div className="h-8 w-40 sm:w-56 bg-slate-800 rounded-lg animate-pulse mb-2" />
        <div className="h-4 w-56 sm:w-72 bg-slate-800/60 rounded animate-pulse mb-8" />

        {/* Filter bar */}
        <div className="flex gap-2 mb-6 overflow-x-auto pb-2">
          {[...Array(4)].map((_, i) => (
            <div key={i} className="h-9 w-24 bg-slate-800/50 rounded-lg animate-pulse shrink-0" />
          ))}
        </div>
