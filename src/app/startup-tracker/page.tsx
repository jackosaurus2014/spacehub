    ...
    <div className="min-h-screen">
      <div className="container mx-auto px-4">
        ...
        <StaggerContainer className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          ...
          <StaggerItem>
            <div className="card-elevated p-6 text-center">
              <div className="text-4xl font-bold font-display tracking-tight text-white/90">{formatTotalFunding(totalFundingMillions)}</div>
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="flex-1">
              ...
              <input
                ...
                className="w-full bg-white/[0.06] border border-white/[0.06] text-white rounded-lg px-3 py-2 h-11 text-sm focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none"
              />
            </div>
            ...
            <div>
              ...
              <select
                ...
                className="bg-white/[0.06] border border-white/[0.06] text-white rounded-lg px-3 py-2 h-11 text-sm focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none min-w-[160px]"
              >
            ...
            <div>
              ...
              <select
                ...
                className="bg-white/[0.06] border border-white/[0.06] text-white rounded-lg px-3 py-2 h-11 text-sm focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none min-w-[140px]"
              >
            ...
            <div>
              ...
              <select
                ...
                className="bg-white/[0.06] border border-white/[0.06] text-white rounded-lg px-3 py-2 h-11 text-sm focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none min-w-[150px]"
              >
          ...
          <div className="flex flex-wrap items-center gap-3 mt-4 pt-3 border-t border-white/[0.06]">
            {hasFilters && (
              <button
                ...
                className="text-sm text-white/90 hover:text-white transition-colors min-h-[44px]"
              >
                Clear All Filters
              </button>
            )}
