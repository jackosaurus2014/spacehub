...
const ECOSYSTEM_SEGMENTS: EcosystemSegment[] = [
  ...
  },
  {
    ...
    companies: [
      ...
      { name: 'Vantor', slug: 'vantor', subsegment: 'Satellite Manufacturers', description: 'Earth observation imagery and geospatial intelligence, split from Maxar Technologies in Oct 2025.', hq: 'Westminster, CO', tags: ['Earth observation', 'geospatial intelligence'] },
      { name: 'Lanteris Space Systems', slug: 'lanteris-space-systems', subsegment: 'Satellite Manufacturers', description: 'Satellite manufacturing and robotic arms (Canadarm), split from Maxar Technologies in Oct 2025.', hq: 'Westminster, CO', tags: ['satellite manufacturing', 'robotics'] },
