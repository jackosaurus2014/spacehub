      ...
      <div className="container mx-auto px-4 pb-16">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="card p-8 space-y-8">
            ...
            {/* Acceptance */}
            <section>
              <h2 className="text-xl font-semibold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent mb-4">1. Acceptance of Terms</h2>
            ...
            {/* Service Description */}
            <section>
              <h2 className="text-xl font-semibold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent mb-4">2. Description of Services</h2>
              <p className="text-slate-400 leading-relaxed mb-4">
            ...
            {/* User Accounts */}
            <section>
              <h2 className="text-xl font-semibold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent mb-4">3. User Accounts</h2>
            ...
            {/* Acceptable Use */}
            <section>
              <h2 className="text-xl font-semibold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent mb-4">4. Acceptable Use Policy</h2>
              <p className="text-slate-400 leading-relaxed mb-4">
            ...
            {/* Community Conduct */}
            <section>
              <h2 className="text-xl font-semibold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent mb-4">5. Community Conduct</h2>
              <p className="text-slate-400 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-xl font-semibold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent mb-4">6. Export Control Compliance</h2>
              <p className="text-slate-400 leading-relaxed mb-4">
            ...
            {/* DMCA and Copyright */}
            <section>
              <h2 className="text-xl font-semibold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent mb-4">7. DMCA and Copyright</h2>
              <p className="text-slate-400 leading-relaxed mb-4">
            ...
            {/* TAKE IT DOWN Act */}
            <section>
              <h2 className="text-xl font-semibold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent mb-4">8. TAKE IT DOWN Act</h2>
              <p className="text-slate-400 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-xl font-semibold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent mb-4">9. Intellectual Property Rights</h2>
            ...
            {/* Third-Party Content */}
            <section>
              <h2 className="text-xl font-semibold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent mb-4">10. Third-Party Content and Services</h2>
              <p className="text-slate-400 leading-relaxed mb-4">
            ...
            {/* Disclaimers */}
            <section>
              <h2 className="text-xl font-semibold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent mb-4">11. Disclaimers</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent mb-4">12. Limitation of Liability</h2>
              <p className="text-slate-400 leading-relaxed mb-4 uppercase font-medium">
            ...
            {/* Indemnification */}
            <section>
              <h2 className="text-xl font-semibold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent mb-4">13. Indemnification</h2>
              <p className="text-slate-400 leading-relaxed">
            ...
            {/* Changes to Terms */}
            <section>
              <h2 className="text-xl font-semibold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent mb-4">14. Changes to Terms</h2>
              <p className="text-slate-400 leading-relaxed">
            ...
            {/* Governing Law */}
            <section>
              <h2 className="text-xl font-semibold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent mb-4">15. Governing Law and Jurisdiction</h2>
              <p className="text-slate-400 leading-relaxed mb-4">
            ...
            {/* Dispute Resolution */}
            <section>
              <h2 className="text-xl font-semibold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent mb-4">16. Dispute Resolution</h2>
              <p className="text-slate-400 leading-relaxed mb-4">
            ...
            {/* Severability */}
            <section>
              <h2 className="text-xl font-semibold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent mb-4">17. Severability</h2>
              <p className="text-slate-400 leading-relaxed">
            ...
            {/* Entire Agreement */}
            <section>
              <h2 className="text-xl font-semibold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent mb-4">18. Entire Agreement</h2>
              <p className="text-slate-400 leading-relaxed">
            ...
            {/* Contact */}
            <section>
              <h2 className="text-xl font-semibold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent mb-4">19. Contact Information</h2>
              <p className="text-slate-400 leading-relaxed mb-4">
