...
const SAMPLE_ARTICLES: Article[] = [
  ...
  {
    id: '3',
    title: 'Blue Origin Reused a New Glenn Booster for the First Time on NG-3',
    summary: 'New Glenn\'s third flight lifted off from LC-36 on April 19 and landed its first stage for a second time — the first reuse of a New Glenn booster — though an upper-stage thrust anomaly left AST SpaceMobile\'s BlueBird-7 satellite in a lower-than-planned orbit.',
    source: 'Ars Technica',
    category: 'Launch',
    publishedAt: '2026-04-19T22:00:00Z',
    url: '#',
  ...
  {
    id: '8',
    title: 'Rocket Lab: Neutron on Track for Q4 2026 Delivery to the Pad',
    summary: 'In its August earnings update, Rocket Lab said the first flight-ready Neutron medium-lift rocket remains on track for delivery to its Wallops Island pad in the fourth quarter of 2026, with over 400 Archimedes engine hot fires completed and the first-flight engine set in production.',
    source: 'Ars Technica',
    category: 'Launch',
  ...
  {
    id: '13',
    title: 'Satellite Operators Press FCC to Rework Five-Year Deorbit Rule',
    summary: 'The FCC\'s rule requiring post-mission deorbit within five years is drawing renewed industry pushback: Amazon has formally urged the Commission to replace the fixed timeline with a more flexible framework, arguing it does not meaningfully improve space safety across diverse mission profiles.',
    source: 'The Verge',
    category: 'Policy',
  ...
  {
    id: '16',
    title: 'Relativity Space Advances Terran R Toward a Late-2026 Debut',
    summary: 'Terran R\'s maiden flight has slipped to late 2026, but hardware is converging: the first-stage qualification article is complete and in factory test, the second stage has shipped to Stennis for cryogenic validation, and engine integration on the flight booster hit a milestone in August.',
    source: 'Ars Technica',
    category: 'Launch',
  ...
  {
    id: '24',
    title: 'Blue Origin Rebuilds LC-36 After Static-Fire Explosion, Targets Year-End Return',
    summary: 'Blue Origin is repairing Launch Complex 36 after a May 28 static-fire explosion destroyed a New Glenn booster and its fueled second stage. The company is preparing alternative second-stage test paths and aims to return New Glenn to flight before the end of 2026, with the Kuiper manifest and the Blue Moon MK1 lander waiting on the pad.',
    source: 'Ars Technica',
    category: 'Launch',
    publishedAt: '2026-07-15T07:30:00Z',
    url: '#',
    imageAlt: 'New Glenn launch pad reconstruction at LC-36, Cape Canaveral',
  },
  {
    id: '25',
...
export default function NewsAggregatorPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black via-black to-black py-8">
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${
                    isActive
                      ...
                      : 'bg-white/[0.04] text-slate-400 hover:bg-white/[0.08] hover:text-white/90'
                  }`}
                >
                  {cat}
                  <span
          ...
          <div className="flex flex-col sm:flex-row gap-3 mb-6">
            ...
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-white/[0.04] border border-white/[0.06] rounded-lg text-sm text-white/90 placeholder-slate-500 focus:outline-none focus:border-white/15 focus:ring-1 focus:ring-white/30 transition-colors"
              />
              {searchQuery && (
                <button
                  onClick={() => {
            ...
            <select
              ...
              className="px-4 py-2.5 bg-white/[0.04] border border-white/[0.06] rounded-lg text-sm text-white/90 focus:outline-none focus:border-white/15 focus:ring-1 focus:ring-white/30 transition-colors appearance-none cursor-pointer"
              style={{
                backgroundImage:
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 ${
                showSourceFilters
                  ...
                  : 'bg-white/[0.04] text-slate-400 border border-white/[0.06] hover:bg-white/[0.08] hover:text-white/90'
              }`}
            >
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path
                      ...
                      <label
                        ...
                        className={`flex items-center gap-2 px-3 py-1.5 rounded-lg cursor-pointer transition-all duration-200 border text-sm focus-within:ring-2 focus-within:ring-white/10 ${
                          isSelected
                            ...
                            : 'bg-white/[0.04] text-slate-500 border-white/[0.06] hover:border-white/[0.1]'
                        }`}
                      >
                        <input
                          type="checkbox"
          ...
          <ScrollReveal>
            <div className="flex justify-center mt-10">
              <button
                ...
                className="px-8 py-3 bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.06] hover:border-white/10 text-slate-300 hover:text-white rounded-xl text-sm font-medium transition-all duration-200 flex items-center gap-2"
              >
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
