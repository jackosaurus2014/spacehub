...
export default function Error({
  ...
  useEffect(() => {
    console.error('[Launch Dashboard] error:', error);
  }, [error]);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-xl font-bold text-white mb-2">Launch Dashboard Error</h2>
        <p className="text-sm text-slate-400 mb-6">
          We encountered an error loading launch data. Please try again.
        </p>
