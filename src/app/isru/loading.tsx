  ...
  return (
    <div className="min-h-screen bg-slate-950 p-4 sm:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="h-4 w-72 sm:w-96 bg-slate-800/60 rounded animate-pulse mb-8" />

        {/* Tab bar */}
        <div className="flex gap-2 mb-8 overflow-x-auto pb-2">
          {[...Array(4)].map((_, i) => (
            <div key={i} className="h-10 w-28 sm:w-32 bg-slate-800/50 rounded-lg animate-pulse shrink-0" />
          ))}
        </div>
