...
const PERSONAS = [
  ...
  },
  {
    ...
    title: 'For Educators',
    description:
      'Free, no-account classroom resources: structured courses, a live satellite tracker, every upcoming launch with countdowns, embeddable widgets, a glossary, and fact-checked explainers on Artemis, the ISS and the rockets flying this year.',
    featureCount: 12,
    icon: (
      <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          ...
          <ScrollReveal>
            <div className="max-w-3xl mx-auto text-center bg-white/[0.04] border border-white/[0.06] rounded-2xl p-8 sm:p-12">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                <Link
                  href="/pricing"
                  className="inline-flex items-center gap-2 px-6 py-3 bg-white hover:bg-slate-100 text-slate-900 font-semibold rounded-lg transition-colors"
                >
                  View Pricing
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M13 7l5 5m0 0l-5 5m5-5H6" />
