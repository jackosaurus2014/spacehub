  ...
  return (
    <div className="min-h-screen py-8">
      <div className="container mx-auto px-4">
        ...
        {/* CTA skeleton */}
        <div className="bg-white/[0.04] rounded-xl animate-pulse p-8 text-center">
          <div className="h-6 w-64 bg-white/[0.04] rounded mx-auto mb-4" />
          <div className="h-4 w-96 max-w-full bg-white/[0.03] rounded mx-auto mb-6" />
          <div className="h-12 w-40 bg-white/30 rounded-xl mx-auto" />
        </div>
      </div>
    </div>
  );
