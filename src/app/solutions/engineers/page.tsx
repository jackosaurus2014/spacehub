  ...
  return (
    <div className="min-h-screen pb-16">
      ...
      <section className="relative py-20 md:py-28 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/10 via-transparent to-slate-300/10 pointer-events-none" />
          ...
          <ScrollReveal>
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  href="/pricing"
                  className="inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-xl bg-gradient-to-r from-emerald-500 to-slate-300 text-white font-semibold hover:from-emerald-400 hover:to-slate-200 transition-all shadow-lg shadow-emerald-500/25 hover:shadow-emerald-500/40"
                >
          ...
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto" staggerDelay={0.08}>
            {FEATURES.map((feature) => (
              <StaggerItem key={feature.name}>
                <Link href={feature.href} className="block rounded-2xl border border-white/[0.06] bg-black/50 p-6 h-full hover:border-emerald-500/30 transition-colors group">
            ...
            <div className="max-w-3xl mx-auto text-center">
              <div className="rounded-2xl border border-white/[0.06] bg-black/50 backdrop-blur-sm p-8 md:p-12">
                <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">
                  Building with SpaceNexus Engineering Tools?
                </h2>
                <p className="text-slate-400 text-lg mb-6 max-w-xl mx-auto">
                  We&apos;d love to hear how SpaceNexus tools are powering your mission design and engineering workflows.
                </p>
                <Link
                  href="/contact"
        ...
        <div className="container mx-auto px-4">
          <ScrollReveal>
            <div className="max-w-2xl mx-auto text-center">
              ...
              <Link
                href="/pricing"
                className="inline-flex items-center gap-2 px-8 py-3.5 rounded-xl bg-gradient-to-r from-emerald-500 to-slate-300 text-white font-semibold hover:from-emerald-400 hover:to-slate-200 transition-all shadow-lg shadow-emerald-500/25 hover:shadow-emerald-500/40"
              >
                Start Free Today
