...
const RESOURCE_CATEGORIES: ResourceCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Space History', href: '/history', description: 'Searchable database of space history events' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Blueprints', href: '/propulsion-database', description: 'Technical hardware breakdowns for space systems' },
      { name: 'Orbital Slots', href: '/spectrum?tab=geo-slots', description: 'GEO slot allocation and availability tracking' },
