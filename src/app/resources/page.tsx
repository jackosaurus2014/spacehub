          ...
          <div>
            ...
            {filtered.length === 0 ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {filtered.map((item) => (
                  <Link key={item.href} href={item.href} className="group block bg-slate-900/60 border border-slate-800 rounded-xl p-5 hover:border-white/15 hover:bg-slate-900/80 transition-all hover:shadow-lg hover:shadow-black/20">
