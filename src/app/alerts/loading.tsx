      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-3">
            ...
            <div>
              <div className="h-8 w-56 bg-white/[0.06] rounded animate-pulse mb-2" />
              <div className="h-1 w-16 bg-white/[0.06] rounded-full animate-pulse" />
            </div>
          </div>
          <div className="h-5 w-96 bg-white/[0.05] rounded animate-pulse mt-3" />
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
          {Array.from({ length: 4 }).map((_, i) => (
            <div
              key={i}
              className="bg-black border border-white/[0.06] rounded-xl p-4 animate-pulse"
            >
        ...
        <div className="flex gap-1 mb-6 bg-black rounded-lg p-1 w-fit">
          {Array.from({ length: 3 }).map((_, i) => (
            <div
              key={i}
              className="h-9 w-28 bg-white/[0.05] rounded-md animate-pulse"
            />
          ))}
        </div>
        ...
        <div className="space-y-4">
          {Array.from({ length: 3 }).map((_, i) => (
            <div
              key={i}
              className="bg-black border border-white/[0.06] rounded-xl p-5 animate-pulse"
            >
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <div className="h-3 w-64 bg-white/[0.06] rounded mb-3" />
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="w-7 h-7 bg-white/[0.06] rounded" />
                </div>
              </div>
            </div>
          ))}
