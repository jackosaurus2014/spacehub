      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex gap-3 mb-6">
          {Array.from({ length: 4 }).map((_, i) => (
            <div
              key={i}
              className="h-10 w-32 bg-white/[0.04] rounded-lg animate-pulse"
            />
          ))}
        </div>
        ...
        <div className="flex gap-6">
          {/* Graph area */}
          <div className="flex-1 bg-white/[0.03] rounded-xl animate-pulse aspect-[16/10] flex items-center justify-center">
