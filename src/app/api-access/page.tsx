...
const API_FEATURES = [
  ...
  },
  {
    ...
    description: 'Monitored 24/7 with automated failover, redundancy, auto-scaling, and global CDN distribution.',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
const CODE_EXAMPLE = `curl -X GET "https://spacenexus.us/api/v1/launches" \\
