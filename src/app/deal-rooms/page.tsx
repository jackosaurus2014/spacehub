      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {!loading && rooms.length === 0 && (
          <div className="text-center py-20">
            <div className="mx-auto w-24 h-24 rounded-2xl bg-gradient-to-br from-cyan-500/15 to-purple-500/15 border border-cyan-500/20 flex items-center justify-center mb-6">
              <svg className="w-12 h-12 text-cyan-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              </svg>
            </div>
            <h3 className="text-2xl font-bold text-slate-100 mb-3">No deal rooms yet</h3>
            <p className="text-slate-400 max-w-lg mx-auto mb-8 leading-relaxed">
              Create a secure deal room to share documents and collaborate with potential partners.
              Protect sensitive materials with NDA requirements, manage member access, and maintain
              a full audit trail of all activity.
            </p>
            <div className="flex flex-wrap justify-center gap-3">
              <button
                onClick={() => setShowCreateForm(true)}
                className="px-6 py-2.5 bg-cyan-600 hover:bg-cyan-500 text-white font-semibold rounded-lg transition-colors flex items-center gap-2"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                </svg>
