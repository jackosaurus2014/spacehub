...
export const metadata: Metadata = {
  ...
  description:
    'A look back at everything SpaceNexus built in 2026: 133 blog articles, 600+ routes, 70+ development waves, SpaceX API integration, livestream detection, and the most comprehensive free space intelligence platform on the internet.',
  keywords: [
  ...
  openGraph: {
    ...
    description:
      '133 blog articles, 600+ routes, 70+ development waves. The story of building the #1 free space intelligence platform.',
