...
// Ported from the retired /government-budgets module (2026-08-14). That page
// compared whole-of-government space budgets across 15+ countries; this tab
// keeps that global comparison distinct from the Budget Tracker tab above,
// which is US-agency line items sourced from our procurement DB.
...
export default function GlobalBudgetsTab() {
  ...
  return (
    <div>
      <DataAsOf date="2024 estimate" note="worldwide government space agency budgets — for US federal line items see the Budget Tracker tab" className="mb-4" />
