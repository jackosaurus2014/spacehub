...
export default function OrbitalServicesPage() {
  ...
  return (
    <div className="min-h-screen bg-space-900">
      {/* Header */}
      <header className="border-b border-space-700 bg-space-800/50">
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div>
              <Link href="/" className="text-star-400 hover:text-star-300 text-sm mb-2 inline-block">
              ...
              <p className="text-star-400 mt-2">
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-space-800 border border-space-700 rounded-xl p-4">
              ...
              <div className="text-star-400 text-sm">Total Services</div>
            </div>
            <div className="bg-space-800 border border-space-700 rounded-xl p-4">
              <div className="text-3xl font-bold text-white">{stats.uniqueProviders}</div>
              <div className="text-star-400 text-sm">Providers</div>
            </div>
            <div className="bg-space-800 border border-space-700 rounded-xl p-4">
              <div className="text-3xl font-bold text-green-400">
                ${(stats.totalContractValue / 1000).toFixed(1)}B
              </div>
              <div className="text-star-400 text-sm">Known Contract Value</div>
            </div>
            <div className="bg-space-800 border border-space-700 rounded-xl p-4">
              <div className="text-3xl font-bold text-white">{stats.totalContracts}</div>
              <div className="text-star-400 text-sm">Active Contracts</div>
            </div>
          </div>
        </div>
      )}
            ...
            {[
              ...
              <button
                ...
                className={`px-4 py-3 text-sm font-medium rounded-t-lg transition-colors ${
                  activeTab === tab.id
                    ? 'bg-space-800 text-white border-t border-l border-r border-space-600'
                    : 'text-star-400 hover:text-white hover:bg-space-800/50'
                }`}
              >
          ...
          <>
            ...
            {activeTab === 'services' && (
              <div>
                ...
                {services.length === 0 && (
                  <div className="text-center py-12 text-star-400">
            ...
            {activeTab === 'contracts' && (
              <div>
                ...
                {/* Contracts Table */}
                <div className="bg-space-800 border border-space-700 rounded-xl overflow-hidden">
                  <div className="overflow-x-auto">
                    <table className="w-full">
                      <thead className="bg-space-700/50">
                        <tr>
                          <th className="text-left px-4 py-3 text-star-300 text-sm font-medium">Contract</th>
                          <th className="text-left px-4 py-3 text-star-300 text-sm font-medium">Customer</th>
                          <th className="text-left px-4 py-3 text-star-300 text-sm font-medium">Provider</th>
                          <th className="text-right px-4 py-3 text-star-300 text-sm font-medium">Value</th>
                          <th className="text-left px-4 py-3 text-star-300 text-sm font-medium">Category</th>
                          <th className="text-left px-4 py-3 text-star-300 text-sm font-medium">Status</th>
                        </tr>
                      </thead>
                      <tbody className="divide-y divide-space-700">
                        {contracts.map((contract) => (
                          <tr key={contract.id} className="hover:bg-space-700/30">
                            <td className="px-4 py-3">
                              <div className="text-white font-medium">{contract.title}</div>
                              <div className="text-star-400 text-xs mt-1 line-clamp-1">
                                {contract.description}
                              </div>
                            </td>
                            <td className="px-4 py-3">
                              <span className="text-star-200">{contract.customerName}</span>
                              <div className="text-star-400 text-xs capitalize">
                                {contract.customerType}
                              </div>
                            </td>
                            <td className="px-4 py-3 text-star-300">{contract.providerName}</td>
                            ...
                            <td className="px-4 py-3">
                              <span className="text-star-300 text-sm capitalize">
            ...
            {activeTab === 'pricing' && (
              <div className="space-y-8">
                <div className="bg-space-800 border border-space-700 rounded-xl p-6">
                  ...
                  <p className="text-star-400 mb-6">
                  ...
                  <div className="grid gap-6 md:grid-cols-2">
                    ...
                    <div className="bg-space-700/50 rounded-lg p-4">
                      ...
                      <div className="space-y-2 text-sm">
                        <div className="flex justify-between">
                          <span className="text-star-400">Optical (30cm)</span>
                          <span className="text-green-400">$25-29/km²</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-star-400">Optical (70cm-1m)</span>
                          <span className="text-green-400">$6-12/km²</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-star-400">SAR Imagery</span>
                          <span className="text-green-400">$10-25/km²</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-star-400">Archive Imagery</span>
                    ...
                    <div className="bg-space-700/50 rounded-lg p-4">
                      ...
                      <div className="space-y-2 text-sm">
                        <div className="flex justify-between">
                          <span className="text-star-400">GPU Compute</span>
                          <span className="text-green-400">$3-6/GPU-hour</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-star-400">Edge Compute</span>
                          <span className="text-green-400">$0.50-2/hour</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-star-400">Energy Advantage</span>
                    ...
                    <div className="bg-space-700/50 rounded-lg p-4">
                      ...
                      <div className="space-y-2 text-sm">
                        <div className="flex justify-between">
                          <span className="text-star-400">Annual Hosting</span>
                          <span className="text-green-400">$500K-$15M/year</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-star-400">Per kg Rate</span>
                          <span className="text-green-400">$25K-75K/kg/year</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-star-400">Rideshare to LEO</span>
                    ...
                    <div className="bg-space-700/50 rounded-lg p-4">
                      ...
                      <div className="space-y-2 text-sm">
                        <div className="flex justify-between">
                          <span className="text-star-400">Ground Station</span>
                          <span className="text-green-400">$3-15/minute</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-star-400">Data Relay</span>
                          <span className="text-green-400">$10K-100K/month</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-star-400">IoT/M2M</span>
                    ...
                    <div className="bg-space-700/50 rounded-lg p-4">
                      ...
                      <div className="space-y-2 text-sm">
                        <div className="flex justify-between">
                          <span className="text-star-400">Target LCOE</span>
                          <span className="text-green-400">$25-50/MWh</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-star-400">Demo Phase</span>
                          <span className="text-yellow-400">2026-2027</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-star-400">Commercial</span>
                    ...
                    <div className="bg-space-700/50 rounded-lg p-4">
                      ...
                      <div className="space-y-2 text-sm">
                        <div className="flex justify-between">
                          <span className="text-star-400">Weather Data</span>
                          <span className="text-green-400">$5K-50K/month</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-star-400">RF Monitoring</span>
                          <span className="text-green-400">$10K-100K/month</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-star-400">AIS Tracking</span>
                ...
                <div className="bg-space-800 border border-space-700 rounded-xl p-6">
                  ...
                  <div className="grid gap-4 md:grid-cols-3">
                    <div className="text-center p-4">
                      ...
                      <div className="text-star-400 text-sm">Rideshare to LEO</div>
                    </div>
                    <div className="text-center p-4">
                      <div className="text-3xl mb-2">⛽</div>
                      <div className="text-xl font-bold text-white">$1M-$10M</div>
                      <div className="text-star-400 text-sm">Annual Ops (per satellite)</div>
                    </div>
                    <div className="text-center p-4">
                      <div className="text-3xl mb-2">📉</div>
                      <div className="text-xl font-bold text-white">30-60%</div>
                      <div className="text-star-400 text-sm">Typical Gross Margin</div>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  {submitted ? (
                    ...
                    <form onSubmit={handleRequestSubmit} className="space-y-5">
                      <div className="grid gap-4 md:grid-cols-2">
                        <div>
                          <label className="block text-star-200 text-sm font-medium mb-2">
                            Your Email
                          </label>
                          <input
                            type="email"
      ...
      {/* Related Modules */}
      <div className="max-w-7xl mx-auto px-4 py-8 border-t border-space-700">
        <h3 className="text-lg font-semibold text-white mb-4">Related Modules</h3>
        <div className="grid gap-4 md:grid-cols-4">
          <Link
            href="/market-intel"
            className="bg-space-800 border border-space-700 rounded-lg p-4 hover:border-space-500 transition-colors"
          >
            <span className="text-2xl">📊</span>
            <h4 className="text-white font-medium mt-2">Market Intel</h4>
            <p className="text-star-400 text-sm">Space company data</p>
          </Link>
          <Link
          ...
          >
            ...
            <p className="text-star-400 text-sm">Frequency allocations</p>
          </Link>
          <Link
          ...
          >
            ...
            <p className="text-star-400 text-sm">Coverage & risk</p>
          </Link>
          <Link
          ...
          >
            ...
            <p className="text-star-400 text-sm">Space commodities</p>
          </Link>
        </div>
      </div>
