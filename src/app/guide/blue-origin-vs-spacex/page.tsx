...
const FAQ = [
  ...
  { q: 'Is Blue Origin cheaper than SpaceX?', a: 'On list price they are close: roughly $68 million for a New Glenn launch versus about $67 million for Falcon 9. Per kilogram New Glenn is cheaper on paper because it lifts twice the mass, but Falcon 9\'s reliability record and schedule certainty are what customers actually pay for today.' },
