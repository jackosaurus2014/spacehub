        ...
        <div className="container mx-auto px-4 pb-20">
          <div className="flex flex-col lg:flex-row gap-10 max-w-7xl mx-auto">
            ...
            <article className="min-w-0 flex-1 max-w-3xl">
              ...
              <section id="spacenexus" className="mb-16 scroll-mt-24">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
                  {[
                    ...
                    { name: 'Business Opportunities', href: '/procurement', desc: 'Government contracts, RFPs, and procurement opportunities' },
              ...
              {/* Guide Navigation */}
              <GuideNavigation currentSlug="commercial-space-economy" />
              <RelatedModules modules={PAGE_RELATIONS['guide/commercial-space-economy']} />
            </article>
            </ScrollReveal>
          </div>
        </div>
