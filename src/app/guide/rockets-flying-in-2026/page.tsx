            ...
            <article className="card p-8 space-y-10">
              ...
              <section id="watch">
                ...
                <ul className="space-y-3 text-slate-400 leading-relaxed">
                  ...
                  <li className="flex items-start gap-3"><span className="mt-2 w-1.5 h-1.5 rounded-full bg-cyan-400 flex-shrink-0" aria-hidden="true" /><span><strong className="text-slate-300">The debutants.</strong> Any vehicle in the not-yet-flown list that gains a manifest date. Neutron and Terran R are the ones the market is waiting on. Related: <Link href="/blog/nasa-relativity-space-terran-r-nls-ii-contract" className="text-cyan-400 hover:text-cyan-300">NASA added Terran R to its launch-services contract</Link> before the rocket has flown.</span></li>
