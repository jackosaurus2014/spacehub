    ...
    >
      ...
      <div className="flex items-start justify-between mb-3">
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-nebula-500/20 to-rocket-500/20 flex items-center justify-center text-xl font-bold text-nebula-400">
          ...
          <div>
            ...
            <span className="text-slate-500 text-sm">{blueprint.manufacturer}</span>
          </div>
        </div>
        ...
        {blueprint.category === 'lander' && (
          <>
            {specs.payloadCapacity && (
              <div className="bg-slate-50 px-3 py-2 rounded-lg">
                <span className="text-xs text-slate-500 block">Payload Capacity</span>
                <span className="text-sm font-semibold text-slate-900">{formatNumber(specs.payloadCapacity)} kg</span>
              </div>
            )}
            {specs.landingMass && (
              <div className="bg-slate-50 px-3 py-2 rounded-lg">
                <span className="text-xs text-slate-500 block">Landing Mass</span>
            ...
            {specs.landingAccuracy && (
              <div className="bg-slate-50 px-3 py-2 rounded-lg">
                <span className="text-xs text-slate-500 block">Landing Accuracy</span>
        ...
        <div className="relative bg-white rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
          ...
          <div className="sticky top-0 bg-white border-b border-slate-200 px-6 py-4 flex items-center justify-between z-10">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 rounded-lg bg-gradient-to-br from-nebula-500/20 to-rocket-500/20 flex items-center justify-center text-2xl font-bold text-nebula-400">
                {getCategoryIcon(blueprint.category)}
              </div>
              <div>
                <h2 className="text-2xl font-bold text-slate-900">{blueprint.name}</h2>
                <div className="flex items-center gap-3 mt-1">
                  <span className="text-slate-600">{blueprint.manufacturer}</span>
