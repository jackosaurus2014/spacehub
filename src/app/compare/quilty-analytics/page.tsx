...
const FEATURE_COMPARISON = [
  ...
  { feature: 'Satellite Tracking', spacenexus: `${SITE_STATS.satellites} objects on interactive 3D globe`, competitor: 'Satellite market analysis in reports', winner: 'spacenexus' },
  ...
  { feature: 'Company Profiles', spacenexus: `${SITE_STATS.companies} interactive profiles with financials`, competitor: 'Select companies covered in depth', winner: 'spacenexus' },
  ...
  return (
    <div className="min-h-screen bg-space-900">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="card p-6 ring-2 ring-white/15">
                ...
                <ul className="space-y-2 text-sm text-slate-400">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-white/70 mt-0.5 flex-shrink-0">&#9656;</span>
                    <span>10 integrated modules, {SITE_STATS.companies} company profiles</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-white/70 mt-0.5 flex-shrink-0">&#9656;</span>
              ...
              <div className="card p-6">
                ...
                <h3 className="text-lg font-bold text-white mb-3">Premium Research Reports</h3>
                <ul className="space-y-2 text-sm text-slate-400">
                  <li className="flex items-start gap-2">
            ...
            <div className="card p-8 space-y-4">
              ...
              <ul className="space-y-3">
                {[
                  ...
                  { title: `${SITE_STATS.companies} company profiles`, desc: 'Interactive profiles with financial data, competitive positioning, satellite assets, and news tagging. Updated automatically, not annually.' },
      ...
      />
        ...
        <RelatedModules modules={PAGE_RELATIONS['compare/quilty-analytics']} />
      </div>
  );
}
