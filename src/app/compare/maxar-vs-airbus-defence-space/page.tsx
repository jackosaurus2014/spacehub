...
export const metadata: Metadata = {
  title: 'Maxar (Vantor / Lanteris) vs Airbus Defence & Space: Complete Comparison 2026',
  description: 'Compare the former Maxar Technologies businesses — now split into Vantor (Earth observation/intelligence) and Lanteris Space Systems (satellite manufacturing) — against Airbus Defence & Space, covering imagery resolution, government contracts, and market position.',
  keywords: ['Maxar vs Airbus', 'Vantor vs Airbus', 'Lanteris Space Systems', 'Earth observation comparison', 'satellite imagery comparison', 'Maxar Technologies', 'Airbus Defence Space 2026'],
  openGraph: {
    title: 'Maxar (Vantor / Lanteris) vs Airbus Defence & Space: Complete Comparison 2026 | SpaceNexus',
    description: 'Side-by-side comparison of the former Maxar Technologies businesses (now Vantor and Lanteris Space Systems) and Airbus Defence & Space in Earth observation, satellite manufacturing, and defense.',
...
export default function Page() {
  return (
    <div className="container mx-auto px-4 py-12 max-w-5xl">
      ...
      <h1 className="text-display text-3xl md:text-4xl mb-3">Maxar (Vantor / Lanteris) vs Airbus Defence &amp; Space</h1>
      <p style={{ color: 'var(--text-secondary)' }} className="text-base max-w-2xl mb-2">
        The two dominant Western providers of commercial high-resolution Earth observation imagery and GEO satellite manufacturing — comparing resolution, archives, government relationships, and satellite buses. In October 2025, Maxar Technologies split into Vantor (Earth observation imagery and geospatial intelligence) and Lanteris Space Systems (satellite manufacturing and robotics); this comparison covers the combined former-Maxar business lines against Airbus Defence &amp; Space.
      </p>
          ...
          <table className="w-full text-xs sm:text-sm">
            <thead>
              <tr style={{ borderBottom: '1px solid var(--border-subtle)' }}>
                ...
                <th className="py-2 sm:py-3 px-2 sm:px-4 text-center text-[11px] sm:text-xs font-bold" style={{ color: 'var(--text-primary)' }}>Airbus Defence &amp; Space</th>
              </tr>
            </thead>
            <tbody>
...
Maxar Technologies was the dominant commercial provider of high-resolution satellite imagery to U.S. government intelligence agencies, primarily through its long-standing contracts with the National Reconnaissance Office. The company went private in 2023 after being acquired by Advent International, following financial difficulties partly driven by satellite losses and launch delays. In October 2025, Maxar split into two independent businesses: Vantor took the Earth observation imagery and geospatial intelligence business (WorldView-3&apos;s 31 cm panchromatic / 1.24 m multispectral resolution, the WorldView Legion constellation aiming to dramatically increase revisit rates, and the NRO relationship), while Lanteris Space Systems took satellite manufacturing and robotics (the 1300-series GEO bus and Canadarm2/OSAM-1 heritage).
      </p>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        headline: 'Maxar (Vantor / Lanteris) vs Airbus Defence & Space: Complete Comparison 2026',
        description: 'Side-by-side comparison of the former Maxar Technologies businesses (now Vantor and Lanteris Space Systems, split October 2025) and Airbus Defence & Space in Earth observation, satellite manufacturing, and defense.',
