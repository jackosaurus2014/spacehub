...
const COMPARISON_DATA = [
  ...
  { metric: 'Latency', a: '~30-50 ms (round trip)', b: '~20-40 ms (round trip)' },
  { metric: 'Terminal Size', a: 'Handheld phone / small IoT modem / vehicle-mounted', b: 'Dish antenna (~20-24 inches) or flat high-performance antenna' },
  ...
  { metric: 'Subscriber Base', a: '~2.2M (commercial + government)', b: '~4M+ (consumer + enterprise + government)' },
