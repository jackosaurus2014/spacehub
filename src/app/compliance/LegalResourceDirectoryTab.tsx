...
export function LegalResourceDirectoryTab() {
  ...
  return (
    <div>
      <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg p-4 mb-6">
        <h4 className="font-semibold text-purple-400 mb-2">Legal Resources Directory</h4>
        <p className="text-sm text-slate-400">Curated directory of law firms, regulations, government agencies, industry organizations, academic programs, and international treaties for space industry professionals.</p>
      </div>
      ...
      <div className="mb-6">
        <div className="relative max-w-2xl">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-3 bg-white/[0.05] border border-white/[0.08] rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-purple-500/40 focus:border-purple-500/40 transition-all"
          />
          {search && (
      ...
      <div className="flex flex-wrap gap-2 mb-8">
        <button
          ...
          className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${
            activeCategory === 'All' ? 'bg-white text-slate-900' : 'bg-white/[0.06] text-slate-400 hover:bg-white/[0.1] hover:text-white'
          }`}
        >
        ...
        {CATEGORIES.map((cat) => (
          <button
            ...
            className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${
              activeCategory === cat ? 'bg-white text-slate-900' : 'bg-white/[0.06] text-slate-400 hover:bg-white/[0.1] hover:text-white'
            }`}
          >
          ...
          return (
            <div key={cat} className="mb-10">
              <div className="flex items-center gap-3 mb-4">
                <div className={`px-3 py-1 rounded-lg bg-gradient-to-b ${CATEGORY_COLORS[cat]} border`}>
    ...
    >
      <div className="flex items-start justify-between gap-3">
        <div className="flex-1 min-w-0">
          <h3 className="text-base font-semibold text-white group-hover:text-purple-300 transition-colors leading-tight">{resource.name}</h3>
        ...
        <svg className="w-4 h-4 text-slate-600 group-hover:text-purple-400 transition-colors shrink-0 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
