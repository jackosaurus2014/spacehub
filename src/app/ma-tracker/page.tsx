...
const TREND_INSIGHTS: TrendInsight[] = [
  {
    ...
    examples: [
      ...
      'RTX -> Blue Canyon Technologies ($700M) for small sat buses',
    ],
  },
  {
  ...
  },
  {
    ...
    examples: [
      ...
      'Anduril -> Area-I ($150M) autonomous systems',
      'Momentus -> Astro Digital ($18M) satellite assets',
    ],
  },
  {
    ...
    examples: [
      'Voyager Space -> Nanoracks ($60M) station ops',
      'Voyager -> Altius Space Machines ($28M) docking tech',
      'Redwire -> Made In Space ($73M) in-space manufacturing',
    ],
  },
];
