      ...
      <ScrollReveal>
        <section className="mb-16">
          ...
          <StaggerContainer className="grid md:grid-cols-3 gap-6">
            ...
            <StaggerItem>
              <div className="card p-6">
                <div className="w-10 h-10 rounded-lg bg-white/[0.08] flex items-center justify-center mb-4">
        ...
        <section className="mb-16">
          ...
          <StaggerContainer className="flex flex-wrap gap-3">
            {TARGET_MODULES.map((mod) => (
              <StaggerItem key={mod}>
                <span
                  className="px-4 py-2 rounded-full bg-white/[0.04] border border-white/[0.06] text-slate-300 text-sm inline-block"
                >
                  {mod}
                </span>
              </StaggerItem>
