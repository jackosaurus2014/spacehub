...
const LAUNCH_PROVIDERS: LaunchProvider[] = [
  ...
  },
  {
    ...
    supportsMars: true,
    supportsCrewed: true,
    notes: 'Fully reusable super-heavy, operational since mid-2026 with a fast-growing flight cadence. Long-run reliability and cost figures still maturing as flight history accumulates.',
  },
  {
    id: 'ula-vulcan',
    name: 'ULA',
