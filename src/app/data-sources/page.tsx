...
const dataCategories: DataCategory[] = [
  {
    ...
    sources: [
      ...
      {
        name: 'SBIR.gov',
        description: 'SBIR/STTR solicitations and award data across NASA, DoD/SpaceWERX, DOE, and NSF',
        updateFrequency: 'Daily',
        tier: 'Free',
      },
      {
        name: 'NASA DONKI',
        description: 'Database Of Notifications, Knowledge, Information — catalogs solar flares, CMEs, and space weather events',
        updateFrequency: 'Every 30 min',
        tier: 'Free',
      },
      {
        name: 'Helioviewer',
        description: 'Solar observation imagery from SDO/SOHO for space weather visualization',
  ...
  },
  {
    ...
    sources: [
      ...
      },
      {
        ...
        description: 'Comprehensive global launch schedule, mission windows, and vehicle/pad data (thespacedevs.com)',
        updateFrequency: 'Every 15 min',
        tier: 'Free',
      },
      {
        name: 'SpaceX API',
        description: 'SpaceX-specific launch, rocket, capsule, and Starlink satellite-count data',
        updateFrequency: 'Every 30 min',
        tier: 'Free',
      },
      {
        name: 'Spaceflight News API',
        description: 'Aggregated space industry news and articles from 50+ publisher sources',
        updateFrequency: 'Every 15 min',
        tier: 'Free',
      },
    ],
