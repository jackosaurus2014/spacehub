    ...
    <div className="min-h-screen bg-slate-950 p-4 sm:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex gap-2 mb-6 overflow-x-auto pb-2">
          {[...Array(5)].map((_, i) => (
            <div key={i} className="h-10 w-24 sm:w-28 bg-slate-800/50 rounded-lg animate-pulse shrink-0" />
          ))}
        </div>
        ...
        <div className="bg-slate-800/50 rounded-xl overflow-hidden animate-pulse">
          {/* Table header */}
          <div className="hidden sm:flex gap-4 p-4 border-b border-slate-700/50">
            {[...Array(5)].map((_, i) => (
          ...
          {/* Table rows */}
          {[...Array(8)].map((_, i) => (
            <div key={i} className="flex flex-col sm:flex-row gap-2 sm:gap-4 p-4 border-b border-slate-700/20">
              {[...Array(5)].map((_, j) => (
