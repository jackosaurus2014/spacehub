...
function PodcastCard({ podcast }: { podcast: Podcast }) {
  return (
    ...
    >
      <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-gradient-to-br from-purple-500/30 to-slate-200/30 border border-purple-400/20 flex items-center justify-center">
      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <ScrollReveal delay={0.2}>
          <div className="mt-16 mb-8 card p-8 text-center">
            ...
            <a
              href="/contact"
              className="inline-flex items-center gap-2 px-6 py-2.5 bg-white hover:bg-slate-100 text-slate-900 text-sm rounded-lg font-medium transition-colors"
            >
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <RelatedModules modules={PAGE_RELATIONS['newsletters-directory']} />
      </div>
    </div>
  );
}
