  ...
  return (
    <div className="min-h-screen">
      <div className="container mx-auto px-4">
        ...
        <ScrollReveal><Link
          href="/tools"
          className="card p-5 mt-8 border border-cyan-500/20 hover:ring-2 hover:ring-cyan-500/50 transition-all group flex items-center gap-4"
        >
          <div className="flex-shrink-0 p-3 rounded-xl bg-cyan-500/10 border border-cyan-500/20 text-cyan-400">
          ...
          <span className="text-cyan-500 group-hover:translate-x-1 transition-transform text-lg flex-shrink-0">
            &rarr;
          </span>
        </Link></ScrollReveal>
