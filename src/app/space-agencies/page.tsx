...
const AGENCIES: Agency[] = [
  { name:'NASA', country:'United States', flag:'\u{1F1FA}\u{1F1F8}', founded:1958, headquarters:'Washington, D.C.', budget:24.4, employees:14000, director:'Jared Isaacman', website:'https://www.nasa.gov', capabilities:['Human Spaceflight','Deep Space Exploration','Earth Science','Aeronautics','Planetary Defense'], notableMissions:['Apollo 11','Space Shuttle','Hubble','Mars Perseverance','Artemis I','JWST'], focus:'Full-spectrum space exploration, science, and aeronautics research', region:'North America' },
  { name:'ESA', country:'Europe (23 member states)', flag:'\u{1F1EA}\u{1F1FA}', founded:1975, headquarters:'Paris, France', budget:9.6, employees:2200, director:'Josef Aschbacher', website:'https://www.esa.int', capabilities:['Launch Vehicles','Earth Observation','Navigation','Science Missions','Human Spaceflight'], notableMissions:['Rosetta','Gaia','JUICE','Ariane 6','Copernicus','ExoMars'], focus:'Collaborative European space exploration, Earth observation, and science', region:'Europe' },
  { name:'CNSA', country:'China', flag:'\u{1F1E8}\u{1F1F3}', founded:1993, headquarters:'Beijing', budget:14.0, employees:150000, director:'Shan Zhongde (Administrator)', website:'http://www.cnsa.gov.cn', capabilities:['Human Spaceflight','Space Station','Lunar Exploration','Mars Exploration','Navigation (BeiDou)'], notableMissions:['Tiangong Space Station','Chang\'e 5/6','Tianwen-1','Shenzhou','BeiDou','Long March 9'], focus:'Rapid buildup of independent space capabilities and deep space exploration', region:'Asia-Pacific' },
  { name:'Roscosmos', country:'Russia', flag:'\u{1F1F7}\u{1F1FA}', founded:1992, headquarters:'Moscow', budget:3.8, employees:170000, director:'Dmitry Bakanov', website:'https://www.roscosmos.ru', capabilities:['Human Spaceflight','Launch Vehicles','Space Station (ISS)','Navigation (GLONASS)','Military Space'], notableMissions:['Soyuz Program','ISS Modules','GLONASS','Luna 25','Angara','Spektr-RG'], focus:'Maintaining legacy launch capability and ISS partnership', region:'Europe' },
  { name:'JAXA', country:'Japan', flag:'\u{1F1EF}\u{1F1F5}', founded:2003, headquarters:'Chofu, Tokyo', budget:2.5, employees:1500, director:'Hiroshi Yamakawa', website:'https://www.jaxa.jp', capabilities:['Launch Vehicles','Asteroid Sample Return','Earth Observation','ISS Operations','Lunar Exploration'], notableMissions:['Hayabusa2','SLIM','H3','Kibo (ISS)','ALOS','MMX'], focus:'Asteroid science, lunar exploration, and advanced space technology', region:'Asia-Pacific' },
