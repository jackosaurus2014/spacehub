...
const AGENCIES: Agency[] = [
  ...
  { name:'CNSA', country:'China', flag:'\u{1F1E8}\u{1F1F3}', founded:1993, headquarters:'Beijing', budget:14.0, employees:150000, director:'Zhang Kejian (Administrator)', website:'http://www.cnsa.gov.cn', capabilities:['Human Spaceflight','Space Station','Lunar Exploration','Mars Exploration','Navigation (BeiDou)'], notableMissions:['Tiangong Space Station','Chang\'e 5/6','Tianwen-1','Shenzhou','BeiDou','Long March 9'], focus:'Rapid buildup of independent space capabilities and deep space exploration', region:'Asia-Pacific' },
