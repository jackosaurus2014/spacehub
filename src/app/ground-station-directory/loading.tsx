      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          {Array.from({ length: 4 }).map((_, i) => (
            <div key={i} className="bg-slate-800/40 rounded-xl animate-pulse p-6 text-center">
        ...
        {/* Search bar */}
        <div className="h-12 w-full bg-slate-800/40 rounded-xl animate-pulse mb-8" />

        {/* Provider cards grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          {Array.from({ length: 8 }).map((_, i) => (
            <div key={i} className="bg-slate-800/40 rounded-xl animate-pulse p-6">
        ...
        <div className="bg-slate-800/40 rounded-xl animate-pulse overflow-hidden">
          ...
          {Array.from({ length: 8 }).map((_, i) => (
            <div key={i} className="h-14 border-t border-slate-700/20 flex items-center gap-4 px-4">
