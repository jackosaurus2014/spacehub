    ...
    <div className="min-h-screen bg-slate-950 p-4 sm:p-6 lg:p-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex gap-2 mb-6 overflow-x-auto pb-2">
          {[...Array(3)].map((_, i) => (
            <div key={i} className="h-9 w-20 bg-slate-800/50 rounded-lg animate-pulse shrink-0" />
          ))}
        </div>
        ...
        <div className="space-y-3">
          {[...Array(10)].map((_, i) => (
            <div key={i} className="bg-slate-800/50 rounded-xl p-4 animate-pulse flex items-start gap-3">
