  ...
  return (
    <div className="min-h-screen bg-slate-950 p-4 sm:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Search bar skeleton */}
        <div className="mb-8">
          <div className="h-12 sm:h-14 w-full bg-slate-800/50 rounded-xl animate-pulse" />
        </div>

        {/* Filter chips */}
        <div className="flex flex-wrap gap-2 mb-6">
          {[...Array(5)].map((_, i) => (
            <div key={i} className="h-8 w-20 sm:w-24 bg-slate-800/50 rounded-full animate-pulse" />
          ))}
        </div>
