  ...
  return (
    <div className="min-h-screen bg-gray-950 flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-xl font-bold text-white mb-2">Messages Error</h2>
        <p className="text-sm text-slate-400 mb-6">
          We encountered an error loading your messages. Please try again or return to the dashboard.
        </p>
