  ...
  return (
    <div className="min-h-screen py-8">
      <div className="container mx-auto px-4">
        {/* Header skeleton */}
        <div className="mb-6">
          <div className="h-8 w-40 bg-white/[0.06] rounded animate-pulse mb-3" />
        </div>

        <div className="flex gap-4 h-[calc(100dvh-12rem)]">
          {/* Sidebar - conversation list */}
          <div className="w-80 shrink-0 space-y-2">
            <div className="h-10 w-full bg-white/[0.04] rounded-lg animate-pulse mb-3" />
            {Array.from({ length: 6 }).map((_, i) => (
              <div key={i} className="bg-white/[0.04] rounded-xl animate-pulse p-4 flex items-center gap-3">
          ...
          {/* Message area */}
          <div className="flex-1 bg-white/[0.02] rounded-xl animate-pulse p-6 flex flex-col">
            {/* Message header */}
            <div className="flex items-center gap-3 pb-4 border-b border-white/[0.06]/40 mb-4">
