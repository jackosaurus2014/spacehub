  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-xl font-bold text-white mb-2">Learning Path Error</h2>
        <p className="text-sm text-slate-400 mb-6">
          Something went wrong loading this page. Please try again or go back to the Learning Center.
        </p>
