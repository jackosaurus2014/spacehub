    ...
    <div className="min-h-screen py-8">
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-center mb-10">
          <div className="w-52 h-52 rounded-full bg-white/[0.04] animate-pulse" />
        </div>
        ...
        {/* Watch list skeleton */}
        <div className="bg-white/[0.04] rounded-xl animate-pulse p-5 mb-8">
        ...
        <div className="bg-white/[0.04] rounded-xl animate-pulse p-5">
