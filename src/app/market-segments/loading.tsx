  ...
  return (
    <div className="min-h-screen py-8">
      <div className="container mx-auto px-4">
        {/* Header skeleton */}
        <div className="mb-8">
          <div className="h-4 w-40 bg-slate-800/60 rounded animate-pulse mb-3" />
        ...
        <div className="bg-slate-800/40 rounded-xl animate-pulse p-6 mb-8 flex items-center gap-8">
