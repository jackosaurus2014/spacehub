      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
          {Array.from({ length: 8 }).map((_, i) => (
            <div key={i} className="bg-slate-800/40 rounded-2xl p-5 animate-pulse">
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-6">
          <div className="h-11 flex-1 bg-slate-800/50 rounded-lg animate-pulse" />
          <div className="h-11 w-40 bg-slate-800/50 rounded-lg animate-pulse" />
          <div className="h-11 w-40 bg-slate-800/50 rounded-lg animate-pulse" />
          <div className="h-11 w-32 bg-slate-800/50 rounded-lg animate-pulse" />
        </div>
