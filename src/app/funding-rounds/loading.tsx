      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          {Array.from({ length: 4 }).map((_, i) => (
            <div key={i} className="bg-slate-800/40 rounded-2xl animate-pulse p-5 space-y-2 border border-slate-700/20">
        ...
        <div className="bg-slate-800/40 rounded-2xl animate-pulse p-5 mb-6 border border-slate-700/20">
        ...
        {/* Table skeleton */}
        <div className="bg-slate-800/40 rounded-2xl animate-pulse border border-slate-700/20 overflow-hidden">
          {/* Header row */}
          ...
          {Array.from({ length: 12 }).map((_, i) => (
            <div key={i} className="flex items-center gap-4 px-4 py-3.5 border-b border-slate-800/30">
