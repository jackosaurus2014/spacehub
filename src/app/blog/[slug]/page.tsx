...
const BLOG_CTA_MAP: Record<string, { tool: string; path: string }> = {
  ...
  'satellite-2026-conference-preview': { tool: 'Space Events', path: '/space-calendar' },
  ...
  'nasa-budget-2026-breakdown-analysis': { tool: 'Government Budgets', path: '/procurement?tab=global-budgets' },
  ...
  'orbital-slots-real-estate-geostationary-orbit': { tool: 'Orbital Slots', path: '/spectrum?tab=geo-slots' },
  ...
  'space-force-budget-where-30-billion-goes': { tool: 'Government Budgets', path: '/procurement?tab=global-budgets' },
  ...
  'smallsat-revolution-cubesats-changing-space': { tool: 'Constellation Tracker', path: '/constellations' },
  'artemis-program-explained-return-to-moon': { tool: 'Mission Control', path: '/mission-control' },
  'reusable-rockets-history-future-2026': { tool: 'Launch Vehicles', path: '/launch-vehicles' },
  'space-economy-jobs-careers-overview-2026': { tool: 'Career Guide', path: '/career-guide' },
  'what-is-earth-observation-satellite-imaging': { tool: 'Satellite Tracker', path: '/satellites' },
  'spacex-starship-complete-guide-2026': { tool: 'Mission Control', path: '/mission-control' },
  'space-mining-asteroid-resources-2026': { tool: 'Space Mining', path: '/space-mining' },
  'satellite-internet-rural-connectivity-2026': { tool: 'Constellation Tracker', path: '/constellations' },
  'international-space-station-guide-2026': { tool: 'Space Stations', path: '/space-stations' },
  'space-weather-impact-technology-infrastructure': { tool: 'Space Weather', path: '/space-weather' },
  'space-law-outer-space-treaty-explained': { tool: 'Compliance Hub', path: '/compliance' },
  'what-is-space-force-us-military-space': { tool: 'Space Defense', path: '/space-defense' },
  'beginner-guide-watching-rocket-launches': { tool: 'Mission Control', path: '/mission-control' },
  'space-industry-investment-trends-q1-2026': { tool: 'Funding Rounds', path: '/funding-rounds' },
  ...
  'state-of-space-march-2026-monthly-report': { tool: 'Monthly Report', path: '/reports/monthly' },
};
