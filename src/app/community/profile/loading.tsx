  ...
  return (
    <div className="min-h-screen py-8">
      <div className="container mx-auto px-4 max-w-7xl">
        {/* Profile header */}
        <div className="bg-white/[0.04] rounded-xl animate-pulse p-6 mb-6 flex items-center gap-5">
        ...
        {/* Bio */}
        <div className="bg-white/[0.04] rounded-xl animate-pulse p-6 mb-6 space-y-3">
