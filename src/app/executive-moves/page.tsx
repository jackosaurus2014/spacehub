  ...
  return (
    <div className="min-h-screen p-4 lg:p-8 max-w-[1600px] mx-auto">
      ...
      {loading ? (
        ...
        <EmptyState
          reason="Moves are extracted from company announcements as they are published. Your current filters exclude every move on file; widening them restores results immediately."
          ...
          description="Try adjusting your search or filters to find executive moves."
        />
      ) : (
        <>
          {/* Desktop Table */}
