        ...
        <section className="section-spacer-sm relative z-10">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
              {topContent.map((card) => (
                <Link
                  key={card.slug}
                  href={card.href}
                  className="group relative card p-6 rounded-2xl border border-slate-700/50 hover:border-white/15 transition-all duration-300 hover:shadow-lg hover:shadow-black/5"
                >
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 mt-8">
              <Link
                href="/blog"
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-slate-800/80 border border-slate-700/50 text-slate-300 hover:text-white hover:border-white/15 transition-all duration-200 text-sm font-medium"
              >
