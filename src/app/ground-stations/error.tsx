...
export default function Error({
  ...
  useEffect(() => {
    console.error('[Ground Stations] error:', error);
  }, [error]);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-xl font-bold text-white mb-2">Ground Stations Error</h2>
        <p className="text-sm text-slate-400 mb-6">
          We encountered an error loading ground station data. Please try again.
        </p>
