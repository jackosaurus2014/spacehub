...
const FALLBACK_HERO_STATS: HeroStat[] = [
  { label: 'Commercial Networks', value: '15+', color: 'text-white/70' },
...
function NetworkCard({ network }: { network: GroundStationNetwork }) {
  ...
  const modelColors: Record<string, string> = {
    ...
    'GaaS': 'text-white/70 bg-white/5 border-white/10',
    ...
    <div className="card-elevated p-6 border border-space-700 hover:border-white/10 transition-all group">
      ...
      <div className="flex items-start justify-between mb-4">
        <div>
          ...
          <div className="flex items-center gap-3 mt-1">
            <span className="text-white/70 text-sm font-medium">{network.stations}</span>
      ...
      <div className="flex flex-wrap gap-1.5 mb-4">
        {(network.bands || []).map((band) => (
          <span
            key={band}
            className="px-2 py-0.5 bg-space-700 text-white/90 border border-space-600 rounded text-xs font-medium"
          >
            {band}
          </span>
        ))}
      ...
      {expanded && (
        <div className="space-y-4 mb-4">
          <div>
            ...
            <p className="text-white/70 text-sm">{network.targetCustomers}</p>
          </div>
          <div>
            <div className="text-slate-500 text-xs uppercase tracking-widest mb-2">Uptime</div>
            <p className="text-white/70 text-sm">{network.uptimeGuarantee}</p>
          </div>
          <div>
        ...
        <tbody>
          {networks.map((network, idx) => (
            ...
            >
              ...
              <td className="py-3 px-4 text-white/70 whitespace-nowrap">{network.stations}</td>
              <td className="py-3 px-4">
                <div className="flex flex-wrap gap-1">
                  {(network.bands || []).map((band) => (
                    <span key={band} className="px-1.5 py-0.5 bg-space-700 text-white/90 rounded text-xs">
                      {band}
                    </span>
                  ))}
                </div>
              </td>
              <td className="py-3 px-4 text-white/70 whitespace-nowrap">{network.coverage}</td>
              <td className="py-3 px-4">
                <span className={`text-xs font-medium px-2 py-0.5 rounded ${
                  network.model === 'GaaS' ? 'text-white/70 bg-white/5' :
              ...
              <td className="py-3 px-4 text-white/70 whitespace-nowrap">{network.pricingModel}</td>
            </tr>
          ))}
        </tbody>
      </table>
    ...
    <div className={`card-elevated p-6 border ${band.borderColor} transition-all`}>
      ...
      <div className="flex flex-wrap gap-1.5 mb-4">
        {(band.commonUsers || []).map((user) => (
          <span key={user} className="px-2 py-0.5 bg-space-700 text-white/70 border border-space-600 rounded text-xs">
            {user}
          </span>
        ))}
      </div>
              ...
              <div className="mt-8 card-elevated p-6 border border-space-700">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="bg-space-800/50 rounded-xl p-4">
                    <div className="text-white/70 text-2xl font-bold mb-1">
            ...
            <div>
              ...
              <div className="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div className="card-elevated p-5 border border-white/10">
                  <h4 className="text-white/70 font-semibold mb-2">GaaS (Ground as a Service)</h4>
              ...
              <div className="mt-6 card-elevated p-6 border border-space-700">
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <span className="text-white/70 font-bold text-sm mt-0.5 flex-shrink-0">01</span>
                  ...
                  <div className="flex items-start gap-3">
                    <span className="text-white/70 font-bold text-sm mt-0.5 flex-shrink-0">02</span>
                    <p className="text-white/70 text-sm">
                  ...
                  <div className="flex items-start gap-3">
                    <span className="text-white/70 font-bold text-sm mt-0.5 flex-shrink-0">03</span>
                    <p className="text-white/70 text-sm">
                  ...
                  <div className="flex items-start gap-3">
                    <span className="text-white/70 font-bold text-sm mt-0.5 flex-shrink-0">04</span>
                    <p className="text-white/70 text-sm">
              ...
              <div className="card-elevated p-6 border border-space-700 mb-6">
                ...
                <div className="relative">
                  ...
                  <div className="flex rounded-lg overflow-hidden h-8">
                    ...
                    <div className="bg-white/30 flex-[2] flex items-center justify-center text-xs text-white/90 font-medium border-r border-space-900">
                      S
                    </div>
                    ...
                    <tbody>
                      {[
                        ...
                        <tr key={idx} className={`border-b border-space-800 ${idx % 2 === 0 ? 'bg-space-900/50' : ''}`}>
                          ...
                          <td className="py-2 px-3 text-white/70 font-medium">{row.band}</td>
          ...
          {activeTab === 'guide' && (
            <div>
                  ...
                  <div className="card-elevated p-6 border border-space-700">
                    ...
                    <div className="space-y-2">
                      {(factor.details || []).map((detail, i) => (
                        <div key={i} className="text-white/70 text-sm flex items-start gap-2 bg-space-800/50 rounded-lg p-3">
                          <span className="text-white/70 font-bold text-xs mt-0.5 flex-shrink-0">
                    ...
                    <tbody>
                      {[
                        ...
                        <tr key={idx} className={`border-b border-space-800 ${idx % 2 === 0 ? 'bg-space-900/50' : ''}`}>
                          ...
                          <td className="py-2 px-3 text-white/70">{row.approach}</td>
                          <td className="py-2 px-3 text-white/70">{row.providers}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
              ...
              <div className="card-elevated p-6 border border-white/10">
                <h3 className="text-white/70 font-semibold mb-4">Operator Best Practices</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-3">
                    <div className="flex items-start gap-2">
                      <span className="text-white/70 font-bold text-sm flex-shrink-0">01</span>
                      <p className="text-white/70 text-sm">
                    ...
                    <div className="flex items-start gap-2">
                      <span className="text-white/70 font-bold text-sm flex-shrink-0">02</span>
                      <p className="text-white/70 text-sm">
                    ...
                    <div className="flex items-start gap-2">
                      <span className="text-white/70 font-bold text-sm flex-shrink-0">03</span>
                      <p className="text-white/70 text-sm">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start gap-2">
                      <span className="text-white/70 font-bold text-sm flex-shrink-0">04</span>
                      <p className="text-white/70 text-sm">
                    ...
                    <div className="flex items-start gap-2">
                      <span className="text-white/70 font-bold text-sm flex-shrink-0">05</span>
                      <p className="text-white/70 text-sm">
                    ...
                    <div className="flex items-start gap-2">
                      <span className="text-white/70 font-bold text-sm flex-shrink-0">06</span>
                      <p className="text-white/70 text-sm">
