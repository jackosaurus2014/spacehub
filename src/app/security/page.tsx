...
const SECURITY_FEATURES = [
  ...
  },
  {
    ...
    description: 'Role-based access controls with least-privilege defaults. SSO/SAML and MFA are on our enterprise roadmap — contact us to discuss your requirements.',
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} aria-hidden="true">
        <path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z" />
      </svg>
    ),
    gradient: 'from-indigo-500/[0.12] to-white/[0.02]',
...
const DATA_PRACTICES = [
  {
    ...
    icon: (
      <svg className="w-5 h-5 text-indigo-400 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden="true">
    ...
    <>
      ...
      <div className="min-h-screen bg-black">
              ...
              <div className="max-w-3xl mx-auto bg-black/50 border border-white/[0.06] rounded-2xl p-8 sm:p-10">
                <div className="flex flex-col md:flex-row items-start gap-6">
                  <div className="shrink-0">
                    <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-indigo-500/10 border border-indigo-500/30">
                      <svg className="w-6 h-6 text-indigo-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} aria-hidden="true">
        ...
        <section className="py-20 px-4">
          <div className="max-w-7xl mx-auto">
            <ScrollReveal>
              <div className="max-w-3xl mx-auto text-center bg-gradient-to-br from-indigo-500/[0.12] to-white/[0.02] border border-indigo-500/20 rounded-2xl p-8 sm:p-12">
                <h2 className="text-2xl md:text-3xl font-bold text-white mb-3">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                  <Link
                    ...
                    className="inline-flex items-center gap-2 px-8 py-3 bg-white hover:bg-slate-100 text-slate-900 font-semibold rounded-lg transition-all shadow-lg shadow-white/[0.05]"
                  >
