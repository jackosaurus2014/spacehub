      ...
      <div className="container mx-auto px-4 pb-16">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="card p-8 space-y-8">
            ...
            {/* Introduction */}
            <section>
              <h2 className="text-xl font-semibold bg-gradient-to-r from-slate-300 to-blue-400 bg-clip-text text-transparent mb-4">What Are Cookies?</h2>
            ...
            {/* How We Use Cookies */}
            <section>
              <h2 className="text-xl font-semibold bg-gradient-to-r from-slate-300 to-blue-400 bg-clip-text text-transparent mb-4">How SpaceNexus Uses Cookies</h2>
              <p className="text-slate-400 leading-relaxed mb-4">
            ...
            {/* Types of Cookies */}
            <section>
              <h2 className="text-xl font-semibold bg-gradient-to-r from-slate-300 to-blue-400 bg-clip-text text-transparent mb-4">Types of Cookies We Use</h2>
            ...
            {/* Cookie Duration */}
            <section>
              <h2 className="text-xl font-semibold bg-gradient-to-r from-slate-300 to-blue-400 bg-clip-text text-transparent mb-4">Cookie Duration</h2>
              <p className="text-slate-400 leading-relaxed mb-4">
            ...
            {/* Third-Party Cookies */}
            <section>
              <h2 className="text-xl font-semibold bg-gradient-to-r from-slate-300 to-blue-400 bg-clip-text text-transparent mb-4">Third-Party Cookies</h2>
              <p className="text-slate-400 leading-relaxed mb-4">
            ...
            {/* Managing Cookies */}
            <section>
              <h2 className="text-xl font-semibold bg-gradient-to-r from-slate-300 to-blue-400 bg-clip-text text-transparent mb-4">How to Manage Cookies</h2>
              <p className="text-slate-400 leading-relaxed mb-4">
            ...
            {/* Do Not Track */}
            <section>
              <h2 className="text-xl font-semibold bg-gradient-to-r from-slate-300 to-blue-400 bg-clip-text text-transparent mb-4">Do Not Track Signals</h2>
              <p className="text-slate-400 leading-relaxed">
            ...
            {/* Updates */}
            <section>
              <h2 className="text-xl font-semibold bg-gradient-to-r from-slate-300 to-blue-400 bg-clip-text text-transparent mb-4">Updates to This Policy</h2>
              <p className="text-slate-400 leading-relaxed">
