...
export default function Error({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  useEffect(() => {
    clientLogger.error('Page error', { page: 'checkout/success', message: error.message, digest: error.digest });
  }, [error]);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-xl font-bold text-white mb-2">Checkout Confirmation Unavailable</h2>
        <p className="text-sm text-slate-400 mb-6">
          We had trouble loading your checkout confirmation. Don&apos;t worry — if your payment was successful, your subscription is active. Check your account or contact support.
        </p>
