...
const REGULATORY_PROCEEDINGS: RegulatoryProceeding[] = [
  ...
  },
  {
    ...
    status: 'Active',
    impact: 'high',
    description: 'Rulemaking to establish a licensing framework for NGSO operations in the 37.5-42 GHz and 47.2-50.2 GHz V-band spectrum, critical for next-gen mega-constellations.',
    date: '2023-2025',
  },
  {
    id: 'fcc-ka-sharing',
  ...
  },
  {
    ...
    status: 'Active',
    impact: 'high',
    description: 'Framework for satellite operators to provide supplemental cellular coverage using terrestrial mobile spectrum bands. Enables Starlink/T-Mobile and AST SpaceMobile direct-to-cell services.',
    date: '2024',
  },
  {
