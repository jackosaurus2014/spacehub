...
export const AUCTIONS: Auction[] = [
  {
    ...
    year: '2022',
    raised: '$22.5B',
    winnerHighlight: 'AT&T, T-Mobile, Dish',
    relevance: 'Adjacent to satellite C-band',
    details: 'The 3.45 GHz mid-band auction (concluded January 2022) cleared spectrum previously used by the Department of Defense and transitioned it to commercial 5G use. AT&T was the largest spender (~$9B), followed by T-Mobile and Dish Network. The proximity to satellite C-band downlinks raises interference concerns for adjacent-band satellite operations.',
  },
  {
    id: 'fcc-107',
