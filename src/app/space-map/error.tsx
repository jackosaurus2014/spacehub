...
export default function SpaceMapError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    clientLogger.error('Space Map page error', {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-xl font-bold text-white mb-2">Failed to load Space Industry Map</h2>
        <p className="text-sm text-slate-400 mb-6">
          Something went wrong while loading the industry map. Please try again.
        </p>
