    ...
    <div className="min-h-screen py-8">
      <div className="container mx-auto px-4">
        ...
        <div className="animate-pulse text-center py-12 mb-8">
          <div className="h-10 w-64 bg-white/[0.06] rounded-lg mx-auto mb-4" />
          <div className="h-5 w-96 max-w-full bg-white/[0.05] rounded mx-auto mb-8" />
          <div className="h-12 w-full max-w-xl bg-white/[0.04] rounded-xl mx-auto" />
        </div>
