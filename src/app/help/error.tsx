...
export default function HelpError({
  ...
  useEffect(() => {
    clientLogger.error('Help Center error', {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-xl font-bold text-white mb-2">Help Center Unavailable</h2>
        <p className="text-sm text-slate-400 mb-6">
          We had trouble loading the Help Center. Please try again or reach out to us directly.
        </p>
