...
// Lazy-load the Comparison and Traffic tabs (~320 lines, only visible when tab selected)
const LazyComparisonTable = dynamic(() => import('./SpaceportsDataTabs').then(m => ({ default: m.SiteComparisonTable })), {
  ssr: false,
  loading: () => <div className="animate-pulse h-96 bg-white/[0.06] rounded-lg" />,
});
const LazyTrafficDataTab = dynamic(() => import('./SpaceportsDataTabs').then(m => ({ default: m.TrafficDataTab })), {
  ssr: false,
  loading: () => <div className="animate-pulse space-y-4"><div className="h-48 bg-white/[0.06] rounded-lg" /><div className="h-64 bg-white/[0.06] rounded-lg" /></div>,
});
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="pb-12">
          ...
          {activeTab === 'comparison' && (
            <LazyComparisonTable activeSpaceports={activeSpaceportsData} />
          )}

          {/* ──────────────── TRAFFIC DATA TAB ──────────────── */}
          {activeTab === 'traffic' && (
            <LazyTrafficDataTab trafficData={trafficDataState} />
          )}
