      ...
      <div className="container mx-auto px-4 pb-16">
        ...
        <div className="max-w-5xl mx-auto">
                ...
                <div className="relative flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-2 mb-1">
                      ...
                      <span className="text-slate-500 group-hover:text-cyan-400 group-hover:translate-x-1 transition-all flex-shrink-0">
          ...
          <section className="mb-12">
            ...
            <Link
              href="/mission-cost"
              className="card p-8 hover:ring-2 hover:ring-cyan-500/50 transition-all group block"
            >
              <div className="flex flex-col md:flex-row md:items-center gap-6">
                <div className="flex-shrink-0 p-4 rounded-xl bg-gradient-to-br from-cyan-500/20 to-blue-500/20 border border-cyan-500/30">
                  <svg className="w-10 h-10 text-cyan-400" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24" aria-hidden="true">
