...
const PRICING_FAQ = [
  ...
  { question: "What's included in the Professional plan?", answer: 'Professional ($19.99/month) is for people who use SpaceNexus for work: unlimited articles, the supply-chain map, the regulatory calendar and compliance suite, the customer-discovery database, satellite pass alerts and webhooks, saved watchlists, API access (5,000 requests a month), an ad-free site and priority support. Everything else on the site -- trackers, the funding-round database, patents, procurement, AI insights, Space Score, the game -- is free for everyone, on purpose.' },
...
const FEATURE_CATEGORIES = [
  {
    ...
    features: [
      ...
      { label: 'Market intelligence', free: true, pro: true },
      { label: 'Space Score rankings', free: true, pro: true },
  ...
  },
  {
    ...
    features: [
      ...
      { label: 'Launch tracking & cost calculator', free: true, pro: 'Full + API' },
      { label: 'Orbital calculator', free: true, pro: true },
      { label: 'Marketplace & resource exchange', free: true, pro: true },
      { label: 'Space insurance calc', free: true, pro: true },
  ...
  },
  {
    ...
    features: [
      { label: 'AI insights', free: true, pro: true },
      { label: 'Funding-round database', free: true, pro: true },
      { label: 'Supply chain map', free: false, pro: true },
      { label: 'Customer discovery database', free: false, pro: true },
      { label: 'Regulatory calendar & compliance', free: false, pro: 'Full suite' },
      { label: 'Patent intelligence', free: true, pro: true },
      { label: 'Procurement (SAM.gov)', free: true, pro: true },
    ],
  },
  {
    name: 'Export & Integration',
    features: [
      { label: 'Data export', free: 'CSV downloads', pro: 'CSV downloads + JSON via API' },
