...
export const SUBSCRIPTION_PLANS: SubscriptionPlan[] = [
  {
    ...
    priceYearly: 0,
    features: [
      'Up to 15 articles per day',
      'Mission Control countdown & schedules',
      'Space weather, debris & environment tracking',
      ...
      'Full Space Score rankings',
      'Funding-round database, patents, procurement (SAM.gov/SBIR)',
      'AI insights, space insurance & resource-exchange calculators',
      'CSV downloads',
...
export const AVAILABLE_MODULES: ModuleConfig[] = [
  ...
  },
  {
    ...
    name: 'Space Capital',
    description: 'Connect space startups with investors -- top VCs, funding trends, and matchmaking tools',
    icon: '💸',
    section: 'business',
    defaultEnabled: true,
    defaultPosition: 15,
