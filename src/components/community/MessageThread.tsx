                ...
                <div className={`max-w-[75%] ${isOwn ? 'order-1' : ''}`}>
                  ...
                  <div
                    className={`px-3 py-2 rounded-2xl text-sm leading-relaxed ${
                      isOwn
                        ? 'bg-white/80 text-white rounded-br-md'
      ...
      <div className="border-t border-slate-700/50 p-3 bg-slate-900/50">
        <form onSubmit={handleSubmit} className="flex items-center gap-2">
          ...
          <button
            ...
            className="p-2.5 bg-white hover:bg-slate-100 text-white rounded-xl transition-colors disabled:opacity-30 disabled:cursor-not-allowed flex-shrink-0"
          >
