      ...
      <Link href={`/community/forums/${categorySlug}/${thread.id}`}>
        <div
          className={`card px-5 py-4 group cursor-pointer transition-colors hover:border-white/10 ${
            thread.isPinned ? 'border-l-2 border-l-white/30' : thread.companyName ? 'border-l-2 border-l-blue-500/50' : ''
          }`}
        >
                ...
                <span className="flex items-center gap-1.5">
                  ...
                  {thread.companyName ? (
                    <span className="flex items-center gap-1">
                      ...
                      <span className="text-blue-400 font-medium">{thread.companyName}</span>
