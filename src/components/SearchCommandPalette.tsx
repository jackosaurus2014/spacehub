...
const ALL_SEARCH_ITEMS: SearchItem[] = [
  ...
  {
    id: 'spectrum',
    label: 'Spectrum Tracker',
    description: 'Frequency allocations and filings',
    href: '/spectrum',
    icon: <SignalIcon />,
    type: 'module',
    category: 'Business',
  ...
  },
  {
    ...
    description: 'Talent trends and salary benchmarks',
    href: '/workforce',
    icon: <UsersIcon />,
    type: 'module',
    category: 'Business',
  ...
  },
  {
    id: 'compliance',
    label: 'Compliance',
    description: 'Export controls and regulations',
    href: '/compliance',
    icon: <ShieldIcon />,
    type: 'module',
    category: 'Tools',
  },
  {
    id: 'solar-flares',
    label: 'Solar Flares',
    description: 'Real-time solar activity',
    href: '/solar-flares',
    icon: <SunIcon />,
    type: 'module',
    category: 'Tools',
  ...
  {
    id: 'debris-monitor',
    label: 'Debris Monitor',
    description: 'Collision risk and tracking',
    href: '/debris-monitor',
    icon: <DebrisIcon />,
    type: 'module',
    category: 'Tools',
  },
  {
    id: 'orbital-slots',
    label: 'Orbital Slots',
    description: 'Satellite population by orbit',
    href: '/orbital-slots',
  ...
  {
    id: 'orbital-services',
    label: 'Orbital Services',
    description: 'On-orbit servicing marketplace',
