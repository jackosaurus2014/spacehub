...
const PATH_TITLES: Record<string, string> = {
  ...
  '/orbital-slots': 'Orbital Management',
  ...
  '/ground-stations': 'Ground Station Map',
  '/space-stations': 'Space Station Tracker',
  '/spaceports': 'Infrastructure Network',
  '/space-manufacturing': 'Manufacturing & Imagery',
  ...
  '/blog': 'SpaceNexus Blog',
  '/ai-insights': 'AI Insights',
  '/company-profiles': 'Company Directory',
  '/search': 'Search',
  '/alerts': 'Alerts',
