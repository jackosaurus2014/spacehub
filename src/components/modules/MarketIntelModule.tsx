    ...
    <div className="card p-4 hover:border-white/15 transition-all">
      ...
      <div className="flex items-start justify-between mb-2">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="font-semibold text-white/90 text-sm">{company.name}</h3>
      ...
      {stockData ? (
        ...
        <div className="animate-pulse">
          ...
          <div className="h-9 w-full bg-white/[0.06] rounded mb-2" />
  ...
  if (companies.length === 0) {
    return (
      <div className="card p-8 text-center">
        ...
        <h3 className="text-xl font-semibold text-white/90 mb-2">Market Intel</h3>
    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-2xl font-display font-bold text-white/90">Market Intel</h2>
                ...
                <button
                  ...
                  className={`flex-shrink-0 px-3 py-1.5 rounded-full text-xs font-mono font-medium transition-all ${
                    isSelected
                      ...
                      : 'bg-white/[0.06] text-slate-400 border border-white/[0.06] hover:border-white/[0.15]'
                  }`}
                >
                  {company.ticker}
                </button>
      ...
      {publicCompanies.length > 0 && (
        <div className="mb-6">
          ...
          <div className="card overflow-hidden">
            {/* Table Header */}
            <div className="grid grid-cols-12 gap-2 px-4 py-2 bg-white/[0.04] border-b border-white/[0.06] text-xs font-medium text-slate-500 uppercase tracking-wider">
            ...
            <div className="max-h-[300px] overflow-y-auto scrollbar-thin">
              {publicCompanies.slice(0, 10).map((company) => {
                ...
                return (
                  <div
                    key={company.id}
                    className="grid grid-cols-12 gap-2 items-center px-4 py-3 border-b border-white/[0.06] last:border-b-0 hover:bg-white/[0.08] transition-colors"
                  >
                    <div className="col-span-5 flex items-center gap-3 min-w-0">
                      <span className="text-lg flex-shrink-0">{countryInfo?.flag || '🌐'}</span>
                      <div className="min-w-0">
                        <div className="font-medium text-white/90 text-sm truncate">{company.name}</div>
                        <span className="text-white/90 font-mono text-xs">{company.exchange}:{company.ticker}</span>
                      </div>
                    </div>
                    ...
                    <div className="col-span-2 text-right">
                      {companyStockData ? (
                        ...
                        <div className="h-4 w-16 bg-white/[0.06] rounded animate-pulse ml-auto" />
                      )}
                    </div>
                    ...
                    <div className="col-span-2 text-right">
                      {companyStockData ? (
                        ...
                        <div className="h-4 w-12 bg-white/[0.06] rounded animate-pulse ml-auto" />
                      )}
                    </div>
