    ...
    <div className="card p-4 hover:border-white/15 transition-all">
      <div className="flex items-start justify-between mb-2">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-mono text-white/90">{item.classification}</span>
        </div>
        <span className="text-lg">{categoryInfo?.icon || '📋'}</span>
      </div>
      <h4 className="font-semibold text-white/90 text-sm mb-1 line-clamp-1">{item.name}</h4>
...
function RegulationCard({ item }: { item: ProposedRegulation }) {
  ...
  return (
    <div className="card p-4 hover:border-white/15 transition-all">
      <div className="flex items-start justify-between mb-2">
        <span className="text-xs font-semibold text-white/90 bg-white/[0.06] px-2 py-0.5 rounded">
          {item.agency}
        </span>
        <span
      ...
      <h4 className="font-semibold text-white/90 text-sm mb-1 line-clamp-2">{item.title}</h4>
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <h4 className="font-medium text-white/90 text-sm truncate">{source.name}</h4>
  ...
  if (!stats || stats.classifications === 0) {
    return (
      <div className="card p-8 text-center">
        ...
        <h3 className="text-xl font-semibold text-white/90 mb-2">Compliance</h3>
    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-2xl font-display font-bold text-white/90">Compliance</h2>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        <div className="card p-3 text-center">
          <div className="text-2xl font-bold text-white/90">{stats.classifications}</div>
