                  ...
                  <div className="flex items-start justify-between flex-wrap gap-2">
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 text-sm mt-2">
                        <div className="bg-white/[0.06] rounded px-2 py-1">
                          <span className="text-slate-400 text-xs">Primary: </span>
                          <span className="text-white/90">{event.primaryObject}</span>
                        ...
                        <div className="bg-white/[0.06] rounded px-2 py-1">
                          ...
                          <span className="text-white/90">{event.secondaryObject}</span>
                    ...
                    <div className="text-right flex-shrink-0">
                      <div className="text-slate-400 text-sm">
                        Miss: <span className="text-white/90 font-medium">{event.missDistance.toFixed(1)} m</span>
                      </div>
                      <div className="text-slate-400 text-sm">
