...
export const FUTURE_DESTINATIONS: FutureDestination[] = [
  {
    ...
    icon: '🌙',
    timeline: '2026-2030',
    description: 'Circumlunar flights will take tourists around the Moon and back, offering views of the lunar far side and the iconic Earthrise. SpaceX\'s Starship is the leading candidate for these missions. The dearMoon project was cancelled in 2024.',
  ...
  },
  {
    ...
    keyPlayers: ['Orbital Assembly (Voyager Station)', 'Vast (Haven-1)', 'Axiom Space (Axiom Station)'],
...
export const TOURISM_MILESTONES: TourismMilestone[] = [
  ...
  { year: 2021, event: 'New Shepard NS-16 (Bezos)', significance: 'Blue Origin\'s first crewed flight with Jeff Bezos, Wally Funk (82), and youngest astronaut Oliver Daemen (18). Ed Dwight (90) later flew on NS-25 in 2024, becoming the oldest person in space.', icon: '🚀' },
  ...
  { year: 2025, event: 'Eos X Space (formerly Space Perspective) test flights', significance: 'Stratospheric balloon tourism enters testing phase, offering gentle ascent to 30km. Company rebranded from Space Perspective to Eos X Space in July 2025.', icon: '🎈' },
...
export const SPACE_TOURISM_OFFERINGS: SpaceTourismOffering[] = [
  ...
  },
  {
    ...
    safetyRecord: '8 crewed flights, 0 incidents; 1 uncrewed failure (NS-23, 2022)',
  },
  {
  ...
  },
  {
    ...
    provider: 'Eos X Space (formerly Space Perspective)',
  ...
  },
  {
    id: 'spacex-dear-moon',
    provider: 'SpaceX',
    name: 'dearMoon Lunar Flyby (Cancelled)',
    experienceType: 'lunar',
    price: null,
    priceDisplay: 'N/A (cancelled 2024)',
    duration: '~6 days round trip (planned)',
    altitude: null,
    altitudeDisplay: '384,400 km (Moon distance)',
    description: 'The dearMoon project, funded by Japanese billionaire Yusaku Maezawa, was cancelled in June 2024 due to Starship development timeline uncertainty. It had aimed to send a crew of artists and creatives on a circumlunar flyby mission aboard SpaceX\'s Starship.',
    features: [
...
export const TOURISM_PROVIDERS = [
  ...
  'Orbital Assembly',
  'Sierra Space',
  'Eos X Space (formerly Space Perspective)',
  'SpaceX',
  'Vast',
  'Virgin Galactic',
  'World View',
...
export const QUICK_COMPARISON_TABLE: ComparisonRow[] = [
  ...
  { provider: 'Eos X Space (formerly Space Perspective)', vehicle: 'Neptune', type: 'balloon', altitude: '30 km', duration: '6 hours', gForces: '0G extra', training: 'Briefing', price: '$125K', seats: 8, status: 'upcoming' },
