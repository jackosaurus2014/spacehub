...
export const LAUNCH_SITES: readonly LaunchSite[] = [
  ...
  { slug: 'wallops', name: 'Wallops Flight Facility', shortName: 'Wallops', region: 'Virginia', country: 'USA', matcher: /Wallops/i, viewingGuide: '/guide/watch-a-launch-wallops', blurb: 'NASA\'s Virginia range: Rocket Lab\'s Electron and Neutron pads and Northrop Grumman\'s Antares.' },
  ...
  { slug: 'kourou', name: 'Guiana Space Centre, Kourou', shortName: 'Kourou', region: 'French Guiana', country: 'France', matcher: /Guiana Space Centre|Kourou/i, viewingGuide: '/guide/watch-a-launch-kourou', blurb: 'Europe\'s spaceport: Ariane 6 and Vega-C, five degrees from the equator.' },
