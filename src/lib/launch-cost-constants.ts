...
export const LAUNCH_COST_AS_OF = '2026-08';
...
export const FALCON9_LIST_PRICE_USD = 67_000_000;
export const FALCON9_LEO_KG = 22_800;
/** ≈ $2,940/kg at full payload. */
...
export const RIDESHARE_PER_KG = 6_500;
export const RIDESHARE_MIN_KG = 50;
export const RIDESHARE_MIN_PRICE_USD = RIDESHARE_PER_KG * RIDESHARE_MIN_KG; // $325k
