...
export const SITE_DIRECTORY: readonly DirectoryGroup[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      { name: 'Live Digest', href: '/briefs', description: 'Rolling 7-day data digest', icon: '📋' },
  ...
  },
  {
    ...
    entries: [
      ...
      { name: 'Investor Hub', href: '/investor-hub', description: 'Everything an investor needs in one place', icon: '💼' },
      ...
      { name: 'Space Score', href: '/space-score', description: 'Composite company scoring', icon: '⭐' },
  ...
  },
  {
    ...
    entries: [
      ...
      { name: 'This Day in Space', href: '/this-day-in-space', description: 'What happened today, historically', icon: '📆' },
