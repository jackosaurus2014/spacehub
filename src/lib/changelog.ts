...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    changes: [
      ...
      { type: 'feature', text: '/beginners — enthusiast-friendly entry point with 6 curated topics linking to tools and articles' },
      { type: 'feature', text: '/this-day-in-space — 30+ verified historical events shown by date (Sputnik, Apollo 11, Hubble, JWST, etc.)' },
      { type: 'feature', text: '/roadmap — public product roadmap with shipped, in-progress, planned, and exploring items' },
      { type: 'feature', text: '/integrations — showcase of 20+ data source connections with refresh frequencies' },
      ...
      { type: 'feature', text: '200 original articles — one of the largest free space content libraries available' },
  ...
  },
  {
    ...
    changes: [
      ...
      { type: 'improvement', text: '160 blog articles — one of the largest free space content libraries available' },
    ],
  },
  {
    version: '2.3.0',
    ...
    changes: [
      ...
      { type: 'improvement', text: '148 total original blog articles — one of the largest free space content libraries available' },
  ...
  },
  {
    ...
    description:
      '70+ waves of recursive development building a comprehensive space intelligence platform. 133 blog articles, 600+ routes, newsletter comparison page, content library stats, Year in Review, and final platform polish.',
    highlight: '133 articles, 70+ waves, 600+ routes',
    changes: [
      { type: 'feature', text: '133 original blog articles — one of the largest free space content libraries available' },
      ...
      { type: 'improvement', text: 'Final changelog v2.2.0 — complete release record for SpaceNexus' },
      { type: 'improvement', text: 'Comprehensive documentation updated with Waves 148-150 and final platform stats' },
      { type: 'improvement', text: 'A comprehensive space intelligence platform' },
    ],
  },
  {
    version: '2.1.0',
  ...
  },
  {
    ...
    description:
      'Major milestone: 100 original blog articles, 30+ modules, 600+ routes, 200+ company profiles, and every tool a space professional needs — all in one platform. SpaceNexus 2.0 is a comprehensive free space intelligence platform.',
    ...
    changes: [
      ...
      { type: 'feature', text: '126 space industry acronyms in the A-Z reference' },
