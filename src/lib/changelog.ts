...
export const CHANGELOG: ChangelogEntry[] = [
  {
    version: '2.1.0',
    date: '2026-03-18',
    title: '100 Articles & Platform Polish',
    description:
      'Wave 140 milestone: 100 original blog articles, blog table of contents, topics index, space industry trends dashboard, alternatives comparison, daily quiz, daily digest, 8 podcast feeds, cross-linked data pages, and a polished "Explore the Platform" homepage section.',
    highlight: '100 articles, 12 new features, 60 waves complete',
    changes: [
      { type: 'feature', text: '100 original blog articles covering the full breadth of the space industry' },
      ...
      { type: 'feature', text: '"100+ Articles" badge displayed across the platform' },
