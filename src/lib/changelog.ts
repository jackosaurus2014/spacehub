...
export const CHANGELOG: ChangelogEntry[] = [
  {
    version: '2.1.0',
    date: '2026-03-18',
    title: '110 Articles & Platform Polish',
    description:
      'Wave 143 milestone: 110 original blog articles, blog table of contents, topics index, space industry trends dashboard, alternatives comparison, daily quiz, daily digest, 8 podcast feeds, cross-linked data pages, and a polished "Explore the Platform" homepage section. Final authority-building wave.',
    highlight: '110 articles, 63 waves complete, 590+ routes',
    changes: [
      { type: 'feature', text: '110 original blog articles covering the full breadth of the space industry' },
      ...
      { type: 'feature', text: '"110+ Articles" badge displayed across the platform' },
