...
export const MARKET_SEGMENTS: MarketSegment[] = [
  {
    ...
    trends: ['Commercialization accelerating', 'Launch costs declining 10x per decade', 'Mega-constellation deployments', 'Defense space spending exceeding civil'],
    source: 'Space Foundation The Space Report 2025 Q2, McKinsey/WEF April 2024',
    color: '#06b6d4',
  },
  {
    id: 'satellite-services',
    name: 'Satellite Services',
    description: 'Revenue from satellite communications, broadcasting, and broadband services (excludes navigation/PNT downstream).',
    ...
    trends: ['LEO broadband disrupting GEO', 'Direct-to-device connectivity', 'IoT from space', 'Traditional DTH declining offset by broadband growth'],
    source: 'SIA SSIR 2025',
    color: '#8b5cf6',
  },
  {
  ...
  },
  {
    ...
    source: 'SIA SSIR 2025, FAA Annual Compendium',
    color: '#ef4444',
  },
  {
    id: 'ground-equipment',
    name: 'Ground Equipment',
    description: 'Revenue from satellite ground terminals, antennas, VSAT, and user equipment (largest satellite industry segment by revenue).',
    parentId: 'global-space-economy',
    currentTAM: 155.3,
    tamYear: 2024,
    projectedTAM: 360,
    ...
    trends: ['Flat-panel antennas for LEO', 'Multi-orbit terminals', 'Software-defined ground stations', 'Starlink terminal demand driving growth'],
    source: 'SIA SSIR 2025',
    color: '#10b981',
  },
  {
  ...
  },
  {
    ...
    description: 'GPS/GNSS downstream services, augmentation, and complementary PNT solutions (counted separately from satellite services by SIA).',
    parentId: 'global-space-economy',
    currentTAM: 110,
    tamYear: 2024,
    projectedTAM: 210,
...
export const HISTORICAL_DATA: MarketDataPoint[] = [
  ...
  { segmentId: 'global-space-economy', year: 2024, value: 613, type: 'actual', source: 'Space Foundation 2025 Q2' },
  { segmentId: 'global-space-economy', year: 2025, value: 676, type: 'projected' },
  { segmentId: 'global-space-economy', year: 2026, value: 746, type: 'projected' },
  { segmentId: 'global-space-economy', year: 2028, value: 907, type: 'projected' },
  { segmentId: 'global-space-economy', year: 2030, value: 1100, type: 'projected' },
  { segmentId: 'global-space-economy', year: 2035, value: 1800, type: 'projected' },

  // Launch services (SIA SSIR 2025)
  { segmentId: 'launch-services', year: 2019, value: 4.9, type: 'actual', source: 'SIA' },
  { segmentId: 'launch-services', year: 2020, value: 5.3, type: 'actual', source: 'SIA' },
  { segmentId: 'launch-services', year: 2021, value: 5.7, type: 'actual', source: 'SIA' },
  { segmentId: 'launch-services', year: 2022, value: 7.1, type: 'actual', source: 'SIA' },
  { segmentId: 'launch-services', year: 2023, value: 8.1, type: 'actual', source: 'SIA' },
  { segmentId: 'launch-services', year: 2024, value: 9.3, type: 'actual', source: 'SIA SSIR 2025' },
  { segmentId: 'launch-services', year: 2030, value: 21, type: 'projected' },
  { segmentId: 'launch-services', year: 2035, value: 33, type: 'projected' },
  ...
  // Satellite services (SIA SSIR 2025 — excludes navigation/PNT downstream)
  { segmentId: 'satellite-services', year: 2019, value: 123, type: 'actual', source: 'SIA' },
  { segmentId: 'satellite-services', year: 2020, value: 117, type: 'actual', source: 'SIA' },
  { segmentId: 'satellite-services', year: 2021, value: 115, type: 'actual', source: 'SIA' },
  { segmentId: 'satellite-services', year: 2022, value: 116, type: 'actual', source: 'SIA' },
  { segmentId: 'satellite-services', year: 2023, value: 105, type: 'actual', source: 'SIA' },
  { segmentId: 'satellite-services', year: 2024, value: 108.3, type: 'actual', source: 'SIA SSIR 2025' },
  { segmentId: 'satellite-services', year: 2030, value: 195, type: 'projected' },
  { segmentId: 'satellite-services', year: 2035, value: 300, type: 'projected' },

  // Ground equipment (SIA SSIR 2025 — largest satellite industry segment)
  { segmentId: 'ground-equipment', year: 2019, value: 130, type: 'actual', source: 'SIA' },
  { segmentId: 'ground-equipment', year: 2020, value: 133, type: 'actual', source: 'SIA' },
  { segmentId: 'ground-equipment', year: 2022, value: 140, type: 'actual', source: 'SIA' },
  { segmentId: 'ground-equipment', year: 2023, value: 148, type: 'actual', source: 'SIA' },
  { segmentId: 'ground-equipment', year: 2024, value: 155.3, type: 'actual', source: 'SIA SSIR 2025' },
  { segmentId: 'ground-equipment', year: 2030, value: 240, type: 'projected' },
  { segmentId: 'ground-equipment', year: 2035, value: 360, type: 'projected' },

  // Satellite manufacturing (SIA SSIR 2025)
  { segmentId: 'satellite-manufacturing', year: 2019, value: 12.5, type: 'actual', source: 'SIA' },
  { segmentId: 'satellite-manufacturing', year: 2020, value: 13.7, type: 'actual', source: 'SIA' },
  { segmentId: 'satellite-manufacturing', year: 2022, value: 16.2, type: 'actual', source: 'SIA' },
  { segmentId: 'satellite-manufacturing', year: 2023, value: 18.2, type: 'actual', source: 'SIA' },
  { segmentId: 'satellite-manufacturing', year: 2024, value: 20, type: 'actual', source: 'SIA SSIR 2025' },
  { segmentId: 'satellite-manufacturing', year: 2030, value: 31, type: 'projected' },
  { segmentId: 'satellite-manufacturing', year: 2035, value: 43, type: 'projected' },
