...
export const JOB_POSTINGS_SEED = [
  ...
  // ── Additional roles - ECLSS, Station Ops, Manufacturing, more ──
  {
    title: 'ECLSS Systems Engineer',
    company: 'Axiom Space',
    location: 'Houston, TX',
    remoteOk: false,
    category: 'engineering' as JobCategory,
    specialization: 'ECLSS',
    seniorityLevel: 'senior' as SeniorityLevel,
    salaryMin: 140000,
    salaryMax: 195000,
    salaryMedian: 167000,
  ...
  {
    title: 'Ground Segment Software Engineer',
    company: 'L3Harris',
  ...
  {
    title: 'Optical Engineer - Space Instruments',
    ...
    isActive: true,
    postedDate: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000),
    sourceUrl: 'https://ball.com/aerospace/careers',
  },
  {
  ...
  {
    title: 'Space Vehicle Design Engineer',
    company: 'Northrop Grumman',
    location: 'Redondo Beach, CA',
    remoteOk: false,
    category: 'engineering' as JobCategory,
  ...
  },
  {
    ...
    isActive: true,
    postedDate: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000),
    sourceUrl: 'https://jpl.nasa.gov/careers',
  },
  {
    title: 'Instrument Scientist - Europa Clipper',
    company: 'NASA JPL',
    location: 'Pasadena, CA',
    remoteOk: false,
    category: 'research' as JobCategory,
    specialization: 'instrument_science',
    seniorityLevel: 'senior' as SeniorityLevel,
    salaryMin: 150000,
    salaryMax: 210000,
    salaryMedian: 180000,
  ...
  {
    title: 'ML Engineer - Earth Observation',
    company: 'Planet Labs',
    location: 'San Francisco, CA',
    remoteOk: true,
    category: 'research' as JobCategory,
  ...
  {
    title: 'Test Engineer - Propulsion',
    company: 'Relativity Space',
  ...
  },
  {
    ...
    remoteOk: false,
    category: 'operations' as JobCategory,
    specialization: 'mission_management',
    seniorityLevel: 'lead' as SeniorityLevel,
    salaryMin: 155000,
    salaryMax: 210000,
    salaryMedian: 182000,
  ...
  {
    title: 'Systems Engineer - New Glenn',
    company: 'Blue Origin',
  ...
  {
    title: 'Manufacturing Engineer - Avionics',
    company: 'Blue Origin',
    location: 'Kent, WA',
    remoteOk: false,
    category: 'manufacturing' as JobCategory,
    specialization: 'avionics_manufacturing',
    seniorityLevel: 'mid' as SeniorityLevel,
    salaryMin: 105000,
    salaryMax: 145000,
    salaryMedian: 125000,
  ...
  {
    title: 'RF Engineer - Antenna Systems',
    company: 'Rocket Lab',
    location: 'Long Beach, CA',
    remoteOk: false,
    category: 'engineering' as JobCategory,
