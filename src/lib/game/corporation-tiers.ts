...
export const CORPORATION_TIERS: CorporationTierDef[] = [
  {
    ...
    unlockedTabs: ['dashboard', 'build', 'research', 'map', 'services', 'contracts'],
  },
  {
    ...
    unlockedTabs: ['fleet', 'reports', 'spatial', 'diplomacy'],
  },
  {
    ...
    unlockedTabs: ['crafting', 'market', 'workforce', 'commanders', 'intelligence'],
  },
  {
