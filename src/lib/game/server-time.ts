...
/** Same clock in milliseconds — the denominator for elapsed-time math
 *  (`elapsedMs / REAL_MS_PER_GAME_MONTH` = game-months elapsed). */
export const REAL_MS_PER_GAME_MONTH = REAL_SECONDS_PER_GAME_MONTH * 1000;
