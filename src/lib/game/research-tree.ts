...
const RAW_RESEARCH: RawResearch[] = [
  ...
  { id: 'fission_surface_power', name: 'Surface Fission Reactor', category: 'solar_arrays', tier: 3, description: 'Compact fission power for planetary surfaces.', effect: '+500% surface power generation. Unlocks nuclear reactors at all locations.', baseCostMoney: 4_000_000_000, baseTimeMonths: 24, prerequisites: ['concentrator_solar'], unlocks: ['nuclear_reactor_leo', 'nuclear_reactor_lunar', 'nuclear_reactor_mars_orbit', 'nuclear_reactor_mars_surface'] },
