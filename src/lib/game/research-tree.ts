...
//
// D5 (2026-09-02, docs/BALANCE.md "D5 flagship economics"): every node whose
// authored cost was >= $50B (34 T5 nodes + mega_structures T4) is priced at
// ONE TENTH of its pre-D5 figure. The pre-reprice ledger lives in
// flagship-economics.ts T5_RESEARCH_REPRICED (guard test enforces the
// pairing); the money it no longer destroys is replaced by the flagship
// upkeep floor. T1–T3 nodes are untouched.
//
// Balance Pass 10 (2026-09-12, docs/BALANCE.md "Pass 10 — early-game pace"):
// every `tier: 1` node's baseCostMoney is HALF its pre-Pass-10 figure
// (durations unchanged). Edited in place — the data is the source of truth.
...
const RAW_RESEARCH: RawResearch[] = [
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  { id: 'reusable_boosters', name: 'Reusable Boosters', category: 'rocketry', tier: 1, description: 'Land and refly first-stage boosters.', effect: '-30% launch cost', baseCostMoney: 100_000_000, baseTimeMonths: 12, prerequisites: [], unlocks: ['launch_pad_medium'] },
  ...
  { id: 'launch_abort_systems', name: 'Launch Abort Systems', category: 'rocketry', tier: 1, description: 'Crew escape during launch failure.', effect: 'Enables crewed launches, +20% safety', baseCostMoney: 75_000_000, baseTimeMonths: 8, prerequisites: [], unlocks: [] },
  ...
  { id: 'space_elevator_cable', name: 'Space Elevator Materials', category: 'rocketry', tier: 5, description: 'Carbon nanotube ribbon for orbital elevator.', effect: '-30% Earth-to-orbit cost (stepping-stone toward full elevator economics)', baseCostMoney: 10_000_000_000, baseTimeMonths: 60, prerequisites: ['mass_driver'], unlocks: [] },
  { id: 'fusion_drive', name: 'Fusion Drive', category: 'rocketry', tier: 5, description: 'Sustained fusion for propulsion.', effect: '-30% travel time everywhere', baseCostMoney: 10_000_000_000, baseTimeMonths: 60, prerequisites: ['nuclear_thermal'], unlocks: [] },
  ...
  { id: 'metallic_hydrogen', name: 'Metallic Hydrogen Propellant', category: 'rocketry', tier: 5, description: 'Theoretical ultra-dense propellant — metastability at ambient pressure has never been demonstrated; treat as a capstone extrapolation, not near-term engineering.', effect: '+30% specific impulse (theoretical; metastability unproven)', baseCostMoney: 8_000_000_000, baseTimeMonths: 48, prerequisites: ['fusion_drive'], unlocks: [] },
  { id: 'launch_site_optimization', name: 'Launch Site Optimization', category: 'rocketry', tier: 1, description: 'Weather prediction and pad turnaround improvements.', effect: '+20% launch success rate', baseCostMoney: 50_000_000, baseTimeMonths: 6, prerequisites: [], unlocks: [] },

  // ═══════════════════════════════════════════════════════════════════════════
  // SPACECRAFT DESIGN (18 researches)
  // ═══════════════════════════════════════════════════════════════════════════
  { id: 'modular_spacecraft', name: 'Modular Spacecraft', category: 'spacecraft', tier: 1, description: 'Standardized docking ports and modules.', effect: 'Enables space stations', baseCostMoney: 75_000_000, baseTimeMonths: 10, prerequisites: [], unlocks: ['space_station_small'] },
  ...
  { id: 'generation_ships', name: 'Generation Ships', category: 'spacecraft', tier: 5, description: 'Self-sustaining vessels for decade-long voyages.', effect: 'Enables outer system colonization', baseCostMoney: 20_000_000_000, baseTimeMonths: 72, prerequisites: ['self_repair'], unlocks: [] },
  { id: 'hull_composites', name: 'Advanced Hull Composites', category: 'spacecraft', tier: 1, description: 'Carbon fiber and ceramic matrix composites.', effect: '-15% spacecraft mass, -10% build cost', baseCostMoney: 60_000_000, baseTimeMonths: 8, prerequisites: [], unlocks: [] },
  ...
  { id: 'emergency_escape', name: 'Emergency Escape Pods', category: 'spacecraft', tier: 1, description: 'Deployable escape capsules for stations.', effect: '+30% crew survival in emergencies', baseCostMoney: 40_000_000, baseTimeMonths: 6, prerequisites: [], unlocks: [] },
  ...
  { id: 'modular_cargo', name: 'Standardized Cargo Containers', category: 'spacecraft', tier: 1, description: 'Universal cargo module for all ship types.', effect: '+20% cargo capacity all ships', baseCostMoney: 45_000_000, baseTimeMonths: 6, prerequisites: [], unlocks: [] },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  { id: 'high_res_optical', name: 'High-Res Optical', category: 'sensors', tier: 1, description: 'Sub-meter imaging from orbit.', effect: '+30% sensor revenue', baseCostMoney: 50_000_000, baseTimeMonths: 8, prerequisites: [], unlocks: ['sat_sensor'] },
  ...
  { id: 'magnetometer_array', name: 'Magnetometer Array', category: 'sensors', tier: 1, description: 'Measure planetary magnetic fields.', effect: '+20% mining survey accuracy', baseCostMoney: 40_000_000, baseTimeMonths: 6, prerequisites: [], unlocks: [] },
  ...
  { id: 'space_weather_monitoring', name: 'Space Weather Monitoring', category: 'sensors', tier: 1, description: 'Solar wind and CME detection satellites.', effect: '+30% storm warning time', baseCostMoney: 60_000_000, baseTimeMonths: 8, prerequisites: [], unlocks: [] },
  ...
  { id: 'gravitational_wave_det', name: 'Gravitational Wave Detector', category: 'sensors', tier: 5, description: 'Space-based gravitational wave observatory.', effect: 'Ultimate sensing capability', baseCostMoney: 5_000_000_000, baseTimeMonths: 48, prerequisites: ['neutrino_detector'], unlocks: [] },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  { id: 'rad_hard_processors', name: 'Rad-Hardened Processors', category: 'ai_chips', tier: 1, description: 'Processors that survive space radiation.', effect: 'Enables orbital data centers', baseCostMoney: 100_000_000, baseTimeMonths: 10, prerequisites: [], unlocks: ['datacenter_orbital'] },
  ...
  { id: 'fpga_reconfigurable', name: 'Reconfigurable FPGA Arrays', category: 'ai_chips', tier: 1, description: 'Field-programmable gate arrays for flexible computing.', effect: '+15% computing efficiency', baseCostMoney: 50_000_000, baseTimeMonths: 6, prerequisites: [], unlocks: [] },
  ...
  { id: 'data_compression', name: 'Neural Data Compression', category: 'ai_chips', tier: 1, description: 'AI-powered data compression for downlinks.', effect: '+30% data throughput', baseCostMoney: 40_000_000, baseTimeMonths: 6, prerequisites: [], unlocks: [] },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  { id: 'improved_cooling', name: 'Improved Cooling Systems', category: 'satellite_components', tier: 1, description: 'Advanced thermal management.', effect: '-15% satellite maintenance', baseCostMoney: 40_000_000, baseTimeMonths: 6, prerequisites: [], unlocks: [] },
  ...
  { id: 'swarm_intelligence', name: 'Swarm Intelligence', category: 'satellite_components', tier: 5, description: 'Satellites coordinate as swarms.', effect: '+30% sensor and telecom revenue', baseCostMoney: 5_000_000_000, baseTimeMonths: 48, prerequisites: ['compact_power', 'neuromorphic_chips'], unlocks: [] },
  { id: 'electric_propulsion_sat', name: 'Electric Propulsion for Satellites', category: 'satellite_components', tier: 1, description: 'Ion thrusters for station-keeping.', effect: '+30% satellite lifespan', baseCostMoney: 50_000_000, baseTimeMonths: 8, prerequisites: [], unlocks: [] },
  ...
  { id: 'satellite_deorbit', name: 'Active Deorbit Systems', category: 'satellite_components', tier: 1, description: 'Controlled deorbit for debris prevention.', effect: '+15% regulatory compliance, -10% insurance', baseCostMoney: 30_000_000, baseTimeMonths: 6, prerequisites: [], unlocks: [] },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  { id: 'triple_junction', name: 'Triple-Junction Solar Cells', category: 'solar_arrays', tier: 1, description: '30%+ efficiency photovoltaics.', effect: 'Enables solar farms, +20% power', baseCostMoney: 30_000_000, baseTimeMonths: 6, prerequisites: [], unlocks: ['solar_farm_orbital'] },
  ...
  { id: 'fusion_reactor', name: 'Fusion Power Reactor', category: 'solar_arrays', tier: 5, description: 'Controlled He-3 fusion for unlimited power.', effect: '+30% power, enables endgame operations', baseCostMoney: 8_000_000_000, baseTimeMonths: 48, prerequisites: ['fission_surface_power'], unlocks: [] },
  { id: 'battery_advanced', name: 'Advanced Energy Storage', category: 'solar_arrays', tier: 1, description: 'Solid-state batteries for space.', effect: '+30% energy storage density', baseCostMoney: 40_000_000, baseTimeMonths: 6, prerequisites: [], unlocks: [] },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  { id: 'resource_prospecting', name: 'Resource Prospecting', category: 'mining', tier: 1, description: 'Survey for extractable resources.', effect: 'Enables lunar/Mars mining', baseCostMoney: 75_000_000, baseTimeMonths: 8, prerequisites: [], unlocks: ['mining_lunar_ice'] },
  ...
  { id: 'automated_mining_fleet', name: 'Automated Mining Fleet', category: 'mining', tier: 5, description: 'Self-replicating mining robots.', effect: '+30% mining revenue', baseCostMoney: 8_000_000_000, baseTimeMonths: 48, prerequisites: ['deep_drilling', 'swarm_intelligence'], unlocks: [] },
  { id: 'isru_water', name: 'Water ISRU', category: 'mining', tier: 1, description: 'In-situ water extraction from ice.', effect: 'Produces propellant locally', baseCostMoney: 60_000_000, baseTimeMonths: 8, prerequisites: ['resource_prospecting'], unlocks: [] },
  ...
  { id: 'subsurface_radar', name: 'Ground Penetrating Radar', category: 'mining', tier: 1, description: 'Map underground deposits from surface.', effect: '+30% deposit discovery rate', baseCostMoney: 40_000_000, baseTimeMonths: 6, prerequisites: [], unlocks: [] },
  ...
  { id: 'self_replicating_miners', name: 'Self-Replicating Miners', category: 'mining', tier: 5, description: 'Mining robots that build copies of themselves — self-replicating industry remains theoretical at any scale (no working demonstration exists); treat as a capstone extrapolation, not near-term engineering.', effect: 'Exponential mining capacity growth', baseCostMoney: 12_000_000_000, baseTimeMonths: 60, prerequisites: ['automated_mining_fleet'], unlocks: [] },

  // ═══════════════════════════════════════════════════════════════════════════
  // SPACE INFRASTRUCTURE (16 researches)
  // ═══════════════════════════════════════════════════════════════════════════
  { id: 'orbital_assembly', name: 'Orbital Assembly', category: 'infrastructure', tier: 1, description: 'Build structures in orbit.', effect: 'Enables fabrication facilities', baseCostMoney: 150_000_000, baseTimeMonths: 12, prerequisites: ['modular_spacecraft'], unlocks: ['fabrication_orbital'] },
  ...
  { id: 'mega_structures', name: 'Mega-Structures', category: 'infrastructure', tier: 4, description: "O'Neill cylinders and large habitats.", effect: '+30% station capacity', baseCostMoney: 5_000_000_000, baseTimeMonths: 48, prerequisites: ['rotating_habitats'], unlocks: [] },
  ...
  { id: 'space_elevator_design', name: 'Space Elevator Architecture', category: 'infrastructure', tier: 5, description: 'Full orbital elevator engineering.', effect: 'Enables near-zero launch cost', baseCostMoney: 15_000_000_000, baseTimeMonths: 72, prerequisites: ['mega_structures', 'space_elevator_cable'], unlocks: [] },
  { id: 'orbital_ring', name: 'Orbital Ring Segment', category: 'infrastructure', tier: 5, description: 'Partial orbital ring around Earth.', effect: '-30% all launch costs', baseCostMoney: 50_000_000_000, baseTimeMonths: 96, prerequisites: ['space_elevator_design'], unlocks: [] },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  { id: 'ion_drives', name: 'Ion Drives', category: 'propulsion', tier: 1, description: 'High-efficiency electric propulsion.', effect: '-30% travel time', baseCostMoney: 60_000_000, baseTimeMonths: 8, prerequisites: [], unlocks: [] },
  ...
  { id: 'jump_drive', name: 'Alcubierre-Class Jump Drive', category: 'propulsion', tier: 5, description: 'Controlled metric-space warp bubble — the Breakthrough of 2147 made commercial. Enables single-jump transit to nearby star systems given sufficient exotic-matter fuel.', effect: 'Enables interstellar expeditions (Starfarer-class ships)', baseCostMoney: 50_000_000_000, baseTimeMonths: 72, prerequisites: ['fusion_drive', 'metallic_hydrogen'], unlocks: ['exotic_matter_refining', 'interstellar_colonization'] },
  { id: 'exotic_matter_refining', name: 'Exotic Matter Refining', category: 'materials', tier: 5, description: 'Production of negative-mass particulates in volume sufficient to sustain jump-drive operations.', effect: 'Enables longer jumps (Alpha Centauri, Sirius); colonies can refine exotic fuel', baseCostMoney: 20_000_000_000, baseTimeMonths: 60, prerequisites: ['jump_drive'], unlocks: [] },
  { id: 'heavy_radiation_shielding', name: 'Heavy Radiation Shielding', category: 'defense', tier: 5, description: 'Multi-layer magnetohydrodynamic shielding rated for white-dwarf accretion environments.', effect: 'Enables high-radiation routes (Sirius); -25% expedition hazard damage', baseCostMoney: 12_000_000_000, baseTimeMonths: 48, prerequisites: ['radiation_hardening'], unlocks: [] },
  { id: 'interstellar_colonization', name: 'Interstellar Colonization', category: 'terraforming', tier: 5, description: 'Closed-loop generational settlement systems for worlds beyond Sol.', effect: 'Enables Colony Ark ships and interstellar colonies', baseCostMoney: 30_000_000_000, baseTimeMonths: 72, prerequisites: ['jump_drive', 'generation_ships'], unlocks: [] },
  ...
  { id: 'fission_fragment', name: 'Fission Fragment Propulsion', category: 'propulsion', tier: 5, description: 'Direct thrust from fission products.', effect: 'ISP > 100,000s, 0.02c-class capstone', baseCostMoney: 30_000_000_000, baseTimeMonths: 60, prerequisites: ['antimatter_propulsion'], unlocks: [] },

  // ═══════════════════════════════════════════════════════════════════════════
  // CREW & WORKFORCE (14 researches)
  // ═══════════════════════════════════════════════════════════════════════════
  { id: 'crew_training', name: 'Advanced Crew Training', category: 'crew', tier: 1, description: 'VR-based astronaut training programs.', effect: '+20% crew efficiency', baseCostMoney: 30_000_000, baseTimeMonths: 6, prerequisites: [], unlocks: [] },
  { id: 'space_medicine', name: 'Space Medicine', category: 'crew', tier: 1, description: 'Counter bone loss and radiation effects.', effect: '+30% crew tour duration', baseCostMoney: 50_000_000, baseTimeMonths: 8, prerequisites: [], unlocks: [] },
  ...
  { id: 'space_nutrition', name: 'Space Nutrition Systems', category: 'crew', tier: 1, description: 'Optimize food production and nutrition.', effect: '-20% life support costs', baseCostMoney: 40_000_000, baseTimeMonths: 6, prerequisites: [], unlocks: [] },
  ...
  { id: 'zero_g_fitness', name: 'Zero-G Fitness Systems', category: 'crew', tier: 1, description: 'Exercise equipment for microgravity.', effect: '+10% crew health, -5% medical costs', baseCostMoney: 20_000_000, baseTimeMonths: 4, prerequisites: [], unlocks: [] },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  { id: 'space_tourism_ops', name: 'Space Tourism Operations', category: 'services', tier: 1, description: 'Commercial passenger space travel.', effect: 'Enables tourism revenue', baseCostMoney: 50_000_000, baseTimeMonths: 8, prerequisites: ['launch_abort_systems'], unlocks: [] },
  { id: 'orbital_advertising', name: 'Orbital Advertising', category: 'services', tier: 1, description: 'LED displays visible from ground.', effect: '+10% station revenue', baseCostMoney: 25_000_000, baseTimeMonths: 4, prerequisites: [], unlocks: [] },
  { id: 'space_burial', name: 'Space Memorial Services', category: 'services', tier: 1, description: 'Launch remains into space/orbit.', effect: 'New niche revenue stream', baseCostMoney: 15_000_000, baseTimeMonths: 4, prerequisites: [], unlocks: [] },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  { id: 'cargo_optimization', name: 'Cargo Loading Optimization', category: 'ships', tier: 1, description: 'AI-optimized cargo placement.', effect: '+15% effective cargo capacity', baseCostMoney: 30_000_000, baseTimeMonths: 4, prerequisites: [], unlocks: [] },
  { id: 'ship_automation', name: 'Ship Automation', category: 'ships', tier: 1, description: 'Automated navigation and docking.', effect: '-30% crew needed per ship', baseCostMoney: 50_000_000, baseTimeMonths: 8, prerequisites: [], unlocks: [] },
  ...
  { id: 'interstellar_probe', name: 'Interstellar Probe Design', category: 'ships', tier: 5, description: 'Probes capable of reaching nearby stars.', effect: 'Enables interstellar exploration', baseCostMoney: 10_000_000_000, baseTimeMonths: 60, prerequisites: ['laser_propulsion', 'fission_fragment'], unlocks: [] },
  ...
  { id: 'magnetic_shield', name: 'Artificial Magnetosphere', category: 'terraforming', tier: 5, description: 'Protect Mars atmosphere from solar wind — an artificial Mars magnetosphere is a real NASA workshop proposal (2017) but remains unbuilt at any scale.', effect: 'Prerequisite for full terraforming', baseCostMoney: 10_000_000_000, baseTimeMonths: 60, prerequisites: ['mars_warming'], unlocks: [] },
  { id: 'ocean_seeding', name: 'Ocean Creation', category: 'terraforming', tier: 5, description: 'Create liquid water oceans from ice.', effect: 'Enables full planetary colonization', baseCostMoney: 20_000_000_000, baseTimeMonths: 72, prerequisites: ['magnetic_shield'], unlocks: [] },
  ...
  { id: 'aerogel_insulation', name: 'Aerogel Insulation', category: 'materials', tier: 1, description: 'Ultra-lightweight thermal insulation.', effect: '-20% thermal management costs', baseCostMoney: 40_000_000, baseTimeMonths: 6, prerequisites: [], unlocks: [] },
  ...
  { id: 'programmable_matter', name: 'Programmable Matter', category: 'materials', tier: 5, description: 'Materials that change shape on command — lab-scale programmable-matter demos exist (claytronics, modular swarm robotics); macro-scale structural reconfiguration on demand remains speculative.', effect: 'Reconfigurable structures', baseCostMoney: 8_000_000_000, baseTimeMonths: 48, prerequisites: ['superconductors', 'neuromorphic_chips'], unlocks: [] },

  // ═══════════════════════════════════════════════════════════════════════════
  // DEFENSE & SAFETY (11 researches — 10 here + heavy_radiation_shielding registered in the interstellar-era block below)
  // ═══════════════════════════════════════════════════════════════════════════
  { id: 'collision_avoidance', name: 'Collision Avoidance Network', category: 'defense', tier: 1, description: 'Space traffic management system.', effect: '-30% collision risk', baseCostMoney: 50_000_000, baseTimeMonths: 8, prerequisites: [], unlocks: [] },
  ...
  { id: 'space_situational', name: 'Space Situational Awareness', category: 'defense', tier: 1, description: 'Track all objects in Earth orbit.', effect: '+20% debris tracking revenue', baseCostMoney: 40_000_000, baseTimeMonths: 6, prerequisites: [], unlocks: [] },
  ...
  { id: 'quantum_cryptanalysis', name: 'Quantum Cryptanalysis', category: 'defense', tier: 5, description: 'Break quantum-encrypted communications using advanced algorithms.', effect: '+4% espionage success rate, ultimate code-breaking', baseCostMoney: 5_000_000_000, baseTimeMonths: 48, prerequisites: ['cyber_warfare_suite', 'quantum_coprocessors'], unlocks: [] },
  { id: 'intelligence_directorate', name: 'Intelligence Directorate', category: 'defense', tier: 5, description: 'Establish a centralized intelligence command overseeing all espionage operations.', effect: 'Unlocks strategic_assessment espionage action, +6% espionage success rate', baseCostMoney: 6_000_000_000, baseTimeMonths: 50, prerequisites: ['counterintelligence_ops', 'quantum_cryptanalysis'], unlocks: [] },
  ...
  { id: 'landing_precision', name: 'Precision Landing', category: 'exploration', tier: 1, description: 'Land within 100m of target.', effect: '+30% landing success', baseCostMoney: 50_000_000, baseTimeMonths: 8, prerequisites: [], unlocks: [] },
  ...
  { id: 'oort_cloud_probe', name: 'Oort Cloud Probe', category: 'exploration', tier: 5, description: 'Probes reaching the Oort cloud.', effect: 'Reveals interstellar resources', baseCostMoney: 5_000_000_000, baseTimeMonths: 48, prerequisites: ['kuiper_belt_survey', 'fusion_drive'], unlocks: [] },
  ...
  { id: 'exoplanet_survey', name: 'Exoplanet Survey', category: 'exploration', tier: 5, description: 'Identify habitable exoplanets.', effect: 'Enables interstellar colonization planning', baseCostMoney: 8_000_000_000, baseTimeMonths: 60, prerequisites: ['gravitational_wave_det', 'interstellar_probe'], unlocks: [] },

  // ═══════════════════════════════════════════════════════════════════════════
  // ECONOMY & TRADE (12 researches)
  // ═══════════════════════════════════════════════════════════════════════════
  { id: 'market_analytics', name: 'Market Analytics Platform', category: 'economy', tier: 1, description: 'AI-driven commodity price prediction.', effect: '+15% trade profit margin', baseCostMoney: 40_000_000, baseTimeMonths: 6, prerequisites: [], unlocks: [] },
  ...
  { id: 'tax_optimization', name: 'Tax Optimization Strategy', category: 'economy', tier: 1, description: 'Minimize operational tax burden.', effect: '-10% all costs', baseCostMoney: 25_000_000, baseTimeMonths: 4, prerequisites: [], unlocks: [] },
  { id: 'brand_management', name: 'Brand & Reputation', category: 'economy', tier: 1, description: 'Build corporate reputation.', effect: '+10% contract win rate', baseCostMoney: 20_000_000, baseTimeMonths: 4, prerequisites: [], unlocks: [] },
