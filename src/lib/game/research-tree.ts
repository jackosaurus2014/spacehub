...
const RAW_RESEARCH: RawResearch[] = [
  ...
  { id: 'nuclear_power_spacecraft', name: 'Spacecraft Nuclear Reactors', category: 'spacecraft', tier: 3, description: 'Compact fission reactors for spacecraft power.', effect: '+200% power generation vs solar. Unlocks deep-space nuclear reactors.', baseCostMoney: 6_000_000_000, baseTimeMonths: 28, prerequisites: ['radiation_shielding'], unlocks: ['nuclear_reactor_asteroid', 'nuclear_reactor_jupiter', 'nuclear_reactor_saturn'] },
  ...
  { id: 'perovskite_tandem', name: 'Perovskite-Si Tandem', category: 'solar_arrays', tier: 2, description: 'Next-gen tandem solar cells.', effect: '+40% power, -30% cost. Unlocks Lunar Orbital Solar Array.', baseCostMoney: 200_000_000, baseTimeMonths: 12, prerequisites: ['triple_junction'], unlocks: ['solar_array_lunar_orbit'] },
  ...
  { id: 'fission_surface_power', name: 'Surface Fission Reactor', category: 'solar_arrays', tier: 3, description: 'Compact fission power for planetary surfaces.', effect: '+500% surface power generation. Unlocks nuclear reactors at all locations.', baseCostMoney: 4_000_000_000, baseTimeMonths: 24, prerequisites: ['concentrator_solar'], unlocks: ['nuclear_reactor_leo', 'nuclear_reactor_mars_orbit', 'nuclear_reactor_mars_surface'] },
  ...
  { id: 'nuclear_electric', name: 'Nuclear Electric Propulsion', category: 'propulsion', tier: 4, description: 'Nuclear reactor powers ion engines.', effect: '-50% outer planet travel time', baseCostMoney: 4_000_000_000, baseTimeMonths: 24, prerequisites: ['nuclear_thermal'], unlocks: [] },
  ...
  { id: 'satellite_as_service', name: 'Satellite-as-a-Service', category: 'services', tier: 3, description: 'Lease satellite capacity on demand.', effect: '+40% telecom flexibility', baseCostMoney: 400_000_000, baseTimeMonths: 14, prerequisites: ['software_defined_sat'], unlocks: [] },
