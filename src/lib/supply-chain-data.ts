...
export const SUPPLY_CHAIN_COMPANIES: SupplyChainCompany[] = [
  ...
  // Tier 1 Suppliers
  {
    ...
    criticality: 'high',
    description: 'Premier rocket propulsion manufacturer (acquired by L3Harris in 2023)',
  ...
  },
  {
    ...
    criticality: 'high',
    description: 'Space instruments and spacecraft manufacturer (acquired by BAE Systems in 2024)',
  ...
  // ── Propulsion Systems Suppliers ────────────────────────────
  {
    ...
    country: 'United States',
    countryCode: 'USA',
    products: ['rocket_engines', 'propulsion_systems', 'hadley_engine', 'arroway_engine'],
    customers: ['northrop-grumman', 'dod', 'commercial-launch'],
    suppliers: ['ati-specialty', 'honeywell-aerospace', 'specialty-metals'],
    criticality: 'high',
    description: 'Modular rocket engine manufacturer producing Hadley (5,000 lbf) and Arroway (200,000 lbf) engines. Supplying Northrop Grumman Firefly for US military launch.',
  ...
  },
  {
    ...
    country: 'United States',
    countryCode: 'USA',
    products: ['rocket_engines', 'e2_engine', 'propulsion_components', '3d_printed_engines'],
    customers: ['vast', 'commercial-launch'],
    suppliers: ['ati-specialty', 'specialty-metals'],
    criticality: 'medium',
    description: 'Acquired by Vast in 2023. Developed 3D-printed E-2 engine using copper alloy combustion chamber. Propulsion technology now integrated into Vast space station program.',
    headquarters: 'Long Beach, CA',
    employeeCount: 200,
  },
  ...
  // ── Avionics & Electronics Suppliers ────────────────────────
  {
    ...
    countryCode: 'GBR',
    products: ['rad_hard_processors', 'rad750', 'space_electronics', 'flight_computers', 'rad_hard_chips'],
    customers: ['nasa', 'lockheed-martin', 'northrop-grumman', 'jpl'],
    suppliers: ['tsmc', 'specialty-semiconductor-fabs'],
    criticality: 'high',
    description: 'Sole manufacturer of the RAD750 flight processor used on Mars rovers (Curiosity, Perseverance), Orion, and dozens of NASA/DoD spacecraft. Developing RAD5545 next-gen processor.',
    headquarters: 'Manassas, VA',
    employeeCount: 90000,
    website: 'https://www.baesystems.com',
  },

  // ── Solar Panels & Power Suppliers ──────────────────────────
  {
    id: 'solaero-rocketlab',
    slug: 'solaero-rocketlab',
    name: 'SolAero Technologies (Rocket Lab)',
    tier: 'tier1',
    country: 'United States',
    countryCode: 'USA',
    products: ['solar_cells', 'solar_panels', 'ztj_cells', 'imm_solar_cells', 'space_grade_solar'],
    customers: ['nasa', 'lockheed-martin', 'northrop-grumman', 'maxar', 'rocket-lab'],
    suppliers: ['specialty-semiconductor-substrates', 'germanium-suppliers'],
    criticality: 'high',
    description: 'Acquired by Rocket Lab in 2022. Premier manufacturer of III-V multi-junction solar cells (ZTJ, IMM-alpha) with >32% efficiency. Powers NASA missions including Mars Insight and Parker Solar Probe.',
    headquarters: 'Albuquerque, NM',
    employeeCount: 500,
    website: 'https://www.rocketlabusa.com',
  },
  {
    id: 'spectrolab-boeing',
    slug: 'spectrolab-boeing',
    name: 'Spectrolab (Boeing)',
    tier: 'tier1',
    country: 'United States',
    countryCode: 'USA',
    products: ['solar_cells', 'xtj_prime_cells', 'solar_panels', 'concentrator_solar'],
    customers: ['boeing', 'lockheed-martin', 'northrop-grumman', 'nasa'],
    suppliers: ['specialty-semiconductor-substrates', 'germanium-suppliers'],
    criticality: 'high',
    description: 'Boeing subsidiary and world largest manufacturer of space solar cells. XTJ Prime cells achieve 30.7% efficiency. Powers ISS, GPS satellites, and most US military spacecraft.',
    headquarters: 'Sylmar, CA',
    employeeCount: 700,
    website: 'https://www.spectrolab.com',
  },
  {
    id: 'azur-space',
    slug: 'azur-space',
    ...
    country: 'Germany',
    countryCode: 'DEU',
    products: ['solar_cells', 'triple_junction_cells', 'space_grade_solar', 'concentrator_cells'],
    customers: ['airbus-defence-space', 'esa', 'thales-alenia', 'ohb-system'],
    suppliers: ['specialty-semiconductor-substrates', 'germanium-wafer-suppliers'],
    criticality: 'high',
    description: 'Leading European manufacturer of III-V triple-junction space solar cells with 30%+ efficiency. Key supplier to ESA and European satellite manufacturers.',
    headquarters: 'Heilbronn, Germany',
    employeeCount: 300,
    website: 'https://www.azurspace.com',
  },

  // ── Thermal Management Suppliers ────────────────────────────
  // Note: Northrop Grumman and Moog are already in the dataset
  // Adding Curtiss-Wright thermal products to its existing entry via products array

  // ── Structures & Materials Suppliers ────────────────────────
  {
    ...
    country: 'United States',
    countryCode: 'USA',
    products: ['composite_structures', 'fuselage_sections', 'rocket_fairings', 'satellite_structures', 'advanced_composites'],
    customers: ['boeing', 'northrop-grumman', 'lockheed-martin', 'blue-origin'],
    suppliers: ['hexcel', 'toray-composites', 'ati-specialty'],
    criticality: 'high',
    description: 'Major aerostructures manufacturer producing composite rocket fairings, structural components, and satellite structures. Being acquired by Boeing (2024).',
  ...
  },
  {
    ...
    country: 'United States',
    countryCode: 'USA',
    products: ['carbon_fiber', 'prepreg_composites', 'honeycomb_structures', 'aerospace_composites'],
    customers: ['spirit-aerosystems', 'boeing', 'airbus-defence-space', 'northrop-grumman', 'spacex'],
    suppliers: ['pan-fiber-suppliers', 'resin-suppliers'],
    criticality: 'high',
    description: 'Leading manufacturer of carbon fiber and composite materials for aerospace. HexPly prepregs and HexWeb honeycomb used in satellite structures, rocket fairings, and launch vehicle components.',
  ...
  {
    id: 'toray-composites',
    slug: 'toray-composites',
    name: 'Toray Composite Materials America',
    tier: 'tier2',
    country: 'Japan',
    countryCode: 'JPN',
    products: ['carbon_fiber', 'torayca_fiber', 'prepreg_materials', 'composite_sheets'],
    customers: ['spirit-aerosystems', 'boeing', 'spacex', 'northrop-grumman'],
    suppliers: ['pan-precursor-suppliers', 'specialty-chemicals'],
    criticality: 'high',
    description: 'World largest carbon fiber manufacturer (Torayca brand). Supplies aerospace-grade carbon fiber for rocket structures, satellite panels, and launch vehicle fairings.',
  ...
  // ── Ground Equipment Suppliers ──────────────────────────────
  {
    ...
    country: 'Norway',
    countryCode: 'NOR',
    products: ['ground_stations', 'satellite_operations', 'ground_network', 'antenna_systems', 'data_downlink'],
    customers: ['nasa', 'esa', 'noaa', 'commercial-satellite-operators'],
    suppliers: ['kongsberg', 'antenna-manufacturers'],
    criticality: 'high',
    description: 'Operates world largest commercial ground station network with 200+ antennas at 25+ locations including polar stations at Svalbard and Antarctica. Critical for LEO satellite operations.',
  ...
  },
  {
    ...
    slug: 'kongsberg-defence',
    name: 'Kongsberg Defence & Aerospace',
    tier: 'tier1',
    country: 'Norway',
    countryCode: 'NOR',
    products: ['ground_systems', 'command_control', 'satellite_control_systems', 'space_surveillance'],
    customers: ['nato', 'norwegian-space-agency', 'esa', 'commercial'],
    suppliers: ['electronics-suppliers', 'software-suppliers'],
    criticality: 'medium',
    description: 'Norwegian defense and space technology company providing ground segment systems, satellite control software, and space domain awareness capabilities.',
  ...
  },
  {
    ...
    country: 'United States',
    countryCode: 'USA',
    products: ['ground_terminals', 'satellite_modems', 'ka_band_systems', 'cybersecurity', 'network_infrastructure'],
    customers: ['dod', 'airlines', 'commercial', 'government'],
    suppliers: ['semiconductor-suppliers', 'antenna-component-suppliers'],
    criticality: 'medium',
    description: 'Global communications company providing satellite ground equipment, Ka-band terminals, and end-to-end satellite communication solutions. Merged with Inmarsat in 2023.',
    headquarters: 'Carlsbad, CA',
    employeeCount: 7000,
    website: 'https://www.viasat.com',
  },

  // ── Testing & Integration Suppliers ─────────────────────────
  {
    id: 'nts',
    slug: 'nts',
    ...
    country: 'United States',
    countryCode: 'USA',
    products: ['environmental_testing', 'vibration_testing', 'thermal_vacuum_testing', 'emc_testing', 'qualification_testing'],
    customers: ['spacex', 'boeing', 'lockheed-martin', 'northrop-grumman', 'nasa'],
    suppliers: ['test-equipment-manufacturers'],
    criticality: 'medium',
    description: 'Largest independent testing laboratory in North America. Provides full environmental qualification testing for spacecraft including vibration, thermal vacuum, acoustic, and EMC/EMI testing.',
    headquarters: 'Calabasas, CA',
    employeeCount: 2500,
    website: 'https://www.nts.com',
  },
  {
    id: 'element-materials',
    slug: 'element-materials',
    name: 'Element Materials Technology',
    tier: 'tier2',
    country: 'United Kingdom',
    countryCode: 'GBR',
    products: ['materials_testing', 'failure_analysis', 'qualification_testing', 'reliability_testing', 'product_assurance'],
    customers: ['airbus-defence-space', 'esa', 'boeing', 'lockheed-martin'],
    suppliers: ['test-equipment-manufacturers'],
    criticality: 'medium',
    description: 'Global materials and product testing provider. Space division provides component qualification, failure analysis, radiation testing, and reliability assessment for European and US space programs.',
  ...
  },
  {
    ...
    country: 'United Kingdom',
    countryCode: 'GBR',
    products: ['mission_operations', 'satellite_control', 'launch_integration', 'ground_segment_operations', 'system_integration'],
    customers: ['esa', 'eumetsat', 'airbus-defence-space', 'commercial'],
    suppliers: ['software-suppliers', 'ground-equipment-suppliers'],
    criticality: 'medium',
    description: 'Major provider of satellite operations, mission control, and systems integration services. Operates ESA ESOC mission control and supports 30+ satellite missions for European agencies.',
...
export const SUPPLY_RELATIONSHIPS: SupplyRelationship[] = [
  ...
  // Ursa Major → Northrop Grumman (rocket engines)
  {
    id: 'rel-21',
    supplierId: 'ursa-major',
    supplierName: 'Ursa Major Technologies',
    customerId: 'northrop-grumman',
    customerName: 'Northrop Grumman',
    products: ['hadley_engine', 'propulsion_systems'],
    annualValue: 100000000,
    geopoliticalRisk: 'none',
    isCritical: true,
    notes: 'Hadley engines for Firefly/NG Antares 330 medium-lift launch vehicle',
  },
  // BAE Systems → Lockheed Martin (rad-hard processors)
  {
    id: 'rel-22',
    supplierId: 'bae-systems',
    supplierName: 'BAE Systems Electronic Systems',
    customerId: 'lockheed-martin',
    customerName: 'Lockheed Martin',
    products: ['rad750_processors', 'flight_computers'],
    annualValue: 50000000,
    geopoliticalRisk: 'none',
    isCritical: true,
    notes: 'RAD750 flight processors for satellite and deep space missions',
  },
  // BAE Systems → NASA/JPL (rad-hard electronics)
  {
    id: 'rel-23',
    supplierId: 'bae-systems',
    supplierName: 'BAE Systems Electronic Systems',
    customerId: 'ball-aerospace',
    customerName: 'Ball Aerospace',
    products: ['rad_hard_processors', 'space_electronics'],
    annualValue: 25000000,
    geopoliticalRisk: 'none',
    isCritical: true,
    notes: 'RAD750 and RAD5545 processors for NASA science missions',
  },
  // SolAero → Maxar (solar cells for satellites)
  {
    id: 'rel-24',
    supplierId: 'solaero-rocketlab',
    supplierName: 'SolAero Technologies (Rocket Lab)',
    customerId: 'maxar',
    customerName: 'Maxar Technologies',
    products: ['solar_cells', 'imm_solar_cells'],
    annualValue: 40000000,
    geopoliticalRisk: 'none',
    isCritical: true,
    notes: 'IMM-alpha high-efficiency solar cells for GEO and MEO satellite buses',
  },
  // Spectrolab → Northrop Grumman (solar cells)
  {
    id: 'rel-25',
    supplierId: 'spectrolab-boeing',
    supplierName: 'Spectrolab (Boeing)',
    customerId: 'northrop-grumman',
    customerName: 'Northrop Grumman',
    products: ['xtj_prime_cells', 'solar_panels'],
    annualValue: 60000000,
    geopoliticalRisk: 'none',
    isCritical: true,
    notes: 'XTJ Prime solar cells for GPS III, SBIRS, and military satellites',
  },
  // Hexcel → Spirit AeroSystems (carbon fiber composites)
  {
    id: 'rel-26',
    supplierId: 'hexcel',
    supplierName: 'Hexcel Corporation',
    customerId: 'spirit-aerosystems',
    customerName: 'Spirit AeroSystems',
    products: ['carbon_fiber', 'prepreg_composites', 'honeycomb_structures'],
    annualValue: 120000000,
    geopoliticalRisk: 'none',
    isCritical: true,
    notes: 'Primary carbon fiber and prepreg supplier for rocket fairing and structure manufacturing',
  },
  // Toray → SpaceX (carbon fiber for Starship and Falcon fairings)
  {
    id: 'rel-27',
    supplierId: 'toray-composites',
    supplierName: 'Toray Composite Materials America',
    customerId: 'spacex',
    customerName: 'SpaceX',
    products: ['torayca_carbon_fiber', 'composite_materials'],
    annualValue: 80000000,
    geopoliticalRisk: 'none',
    isCritical: true,
    notes: 'High-modulus carbon fiber for Falcon 9 fairings, Dragon capsule structures',
  },
  // KSAT → NASA (ground station services)
  {
    id: 'rel-28',
    supplierId: 'ksat',
    supplierName: 'KSAT',
    customerId: 'maxar',
    customerName: 'Maxar Technologies',
    products: ['ground_station_services', 'data_downlink', 'satellite_operations'],
    annualValue: 30000000,
    geopoliticalRisk: 'none',
    isCritical: false,
    notes: 'Ground station network services for Earth observation satellite downlink',
  },
  // NTS → SpaceX (environmental testing)
  {
    id: 'rel-29',
    supplierId: 'nts',
    supplierName: 'NTS',
    customerId: 'spacex',
    customerName: 'SpaceX',
    products: ['vibration_testing', 'thermal_vacuum_testing', 'qualification_testing'],
    annualValue: 15000000,
    geopoliticalRisk: 'none',
    isCritical: false,
    notes: 'Component and subsystem qualification testing for Falcon and Dragon programs',
  },
  // Azur Space → Airbus Defence (solar cells for European satellites)
  {
    id: 'rel-30',
    supplierId: 'azur-space',
    supplierName: 'Azur Space Solar Power',
    customerId: 'airbus-defence-space',
    customerName: 'Airbus Defence and Space',
    products: ['triple_junction_cells', 'space_grade_solar'],
    annualValue: 35000000,
    geopoliticalRisk: 'none',
    isCritical: true,
    notes: 'Primary European supplier of space solar cells for ESA and Airbus satellite programs',
  },
];
...
export const SUPPLY_SHORTAGES: SupplyShortage[] = [
  ...
  // ── ITAR & Regulatory Restrictions ──────────────────────────

  {
    id: 'shortage-36',
    material: 'ITAR-Restricted Propulsion Components',
    category: 'propulsion',
    affectedProducts: ['rocket_engines', 'turbopumps', 'injectors', 'thrust_vector_controls'],
    severity: 'high',
    alternativeSuppliers: ['aerojet-rocketdyne', 'ursa-major', 'blue-origin-internal'],
    notes: 'International Traffic in Arms Regulations (ITAR) strictly limit export of propulsion technology. Non-US companies cannot source American-made rocket engines, turbopumps, or key propulsion subsystems. This creates parallel supply chains: US companies use domestic suppliers (Aerojet Rocketdyne, Ursa Major) while European programs rely on ArianeGroup/Safran. ITAR compliance adds 6-12 months to international collaboration timelines and requires dedicated clean rooms and controlled networks. Foreign nationals cannot access ITAR data, limiting the global talent pool for propulsion engineering.',
    estimatedResolution: 'Ongoing',
    impactedCompanies: ['airbus-defence-space', 'arianegroup', 'thales-alenia', 'rocket-lab'],
    geopoliticalFactors: ['ITAR_Export_Controls', 'US_Munitions_List', 'Technology_Transfer_Restrictions'],
  },

  // ── Carbon Fiber Composites (Expanded) ──────────────────────

  {
    id: 'shortage-37',
    material: 'Aerospace-Grade PAN Carbon Fiber Precursor',
    category: 'structures',
    affectedProducts: ['carbon_fiber_composites', 'rocket_fairings', 'pressure_vessels', 'satellite_structures'],
    severity: 'high',
    alternativeSuppliers: ['toray-composites', 'hexcel', 'sgl-carbon', 'mitsubishi-rayon'],
    notes: 'Polyacrylonitrile (PAN) precursor fiber is the base material for aerospace carbon fiber. Toray (Japan) controls 50%+ of the market. Aerospace-grade PAN requires specialized spinning and oxidation processes with 12-month qualification cycles. With carbon fiber demand growing 15%/year from launch vehicle, satellite, and space station programs, supply is tightening. Small-batch aerospace orders (100-500 kg) compete with high-volume automotive and wind energy orders (10,000+ kg). Price premiums for aerospace-grade fiber are 3-5x commercial grade.',
    estimatedResolution: '2027',
    impactedCompanies: ['spacex', 'rocket-lab', 'boeing', 'northrop-grumman', 'spirit-aerosystems'],
    geopoliticalFactors: ['Japan_Supply_Concentration', 'Aerospace_vs_Commercial_Demand'],
  },
  ...
  {
    id: 'shortage-38',
    material: 'Inconel Superalloy Forgings (718/625)',
    category: 'specialty_metals',
    affectedProducts: ['rocket_engine_chambers', 'turbopump_housings', 'exhaust_nozzles', 'high_temp_components'],
    severity: 'high',
    alternativeSuppliers: ['ati-specialty', 'special-metals-carpenter', 'howmet-aerospace'],
    notes: 'Inconel 718 and 625 nickel-chromium superalloys are essential for rocket engine combustion chambers, turbopumps, and exhaust systems operating at 1000C+. ATI, Special Metals (Carpenter Technology), and Howmet Aerospace are the primary Western suppliers. Lead times for large aerospace forgings are 18-24 months. The alloys require vacuum induction melting (VIM) and vacuum arc remelting (VAR) processes with limited global capacity. Additive manufacturing (3D printing) of Inconel is reducing lead times for some components, but qualification remains a bottleneck. SpaceX Raptor engine uses significant quantities of Inconel variants.',
    estimatedResolution: '2027',
    impactedCompanies: ['spacex', 'aerojet-rocketdyne', 'blue-origin', 'ursa-major', 'ula'],
    geopoliticalFactors: ['Forging_Capacity_Constraints', 'Nickel_Supply_Chain'],
  },
  ...
  {
    id: 'shortage-39',
    material: 'Ground Station Antenna Systems (S/X/Ka-Band)',
    category: 'ground_equipment',
    affectedProducts: ['ground_stations', 'satellite_control', 'data_downlink', 'ttt_systems'],
    severity: 'medium',
    alternativeSuppliers: ['ksat', 'kongsberg-defence', 'viasat', 'general-dynamics-mission-systems'],
    notes: 'The explosion of LEO mega-constellations and small satellite missions has created unprecedented demand for ground station antenna systems. Each new satellite operator needs dedicated ground infrastructure. KSAT, SSC (Swedish Space Corp), and AWS Ground Station provide network services, but many government and defense customers require dedicated antennas. Large reflector antennas (9-13m) for deep space have 18-24 month lead times. Smaller LEO tracking antennas (2.4-5m) are available in 6-12 months but demand is outpacing production capacity. Ground station real estate at polar and equatorial locations is becoming scarce.',
    estimatedResolution: '2027',
    impactedCompanies: ['ksat', 'viasat', 'maxar', 'boeing', 'lockheed-martin'],
    geopoliticalFactors: ['Ground_Station_Real_Estate', 'RF_Spectrum_Competition'],
  },
  ...
  {
    id: 'shortage-40',
    material: 'Thermal Vacuum Chamber Availability',
    category: 'testing_integration',
    affectedProducts: ['satellite_qualification', 'spacecraft_testing', 'component_qualification', 'flight_hardware_acceptance'],
    severity: 'medium',
    alternativeSuppliers: ['nts', 'element-materials', 'nasa-goddard', 'esa-estec'],
    notes: 'Thermal vacuum (TVAC) testing is mandatory for all flight hardware. Chamber time at NTS, Element Materials, and government facilities (NASA GSFC, JSC, JPL, ESA ESTEC) is booked 6-12 months in advance. Large chambers capable of full spacecraft testing are extremely limited globally. With commercial space companies producing hardware at higher rates than traditional programs, queue times are extending. Some companies are building dedicated chambers (SpaceX, Rocket Lab), but these require $5-20M capital investment and 12-18 months to construct and qualify. The bottleneck particularly impacts small satellite companies without in-house facilities.',
    estimatedResolution: '2027',
    impactedCompanies: ['spacex', 'rocket-lab', 'boeing', 'northrop-grumman', 'ball-aerospace'],
    geopoliticalFactors: ['Testing_Infrastructure_Capacity'],
  },
];
...
export function getSupplyChainStats() {
  ...
  return {
    ...
    europeanCompanies: companies.filter((c) => ['EUR', 'FRA', 'DEU', 'GBR', 'CHE', 'NOR'].includes(c.countryCode)).length,
  };
}
