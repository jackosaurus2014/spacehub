...
const SPACE_INVESTORS: InvestorData[] = [
  ...
  {
    name: 'Boeing Ventures',
    type: 'corporate',
    description: 'Boeing\'s venture capital arm (formerly HorizonX, rebranded 2022) investing in disruptive technologies across aerospace, autonomy, and space.',
  ...
  },
  {
    ...
    type: 'government',
    description: 'Space-focused nonprofit dedicated to planetary defense and asteroid tracking. Supports early-stage SSA companies.',
    ...
    portfolioCount: 2,
    notableDeals: ['LeoLabs (supported)'],
  },
  {
    name: 'Decisive Point',
    type: 'vc',
  ...
  {
    name: 'Explorer 1 Fund',
    type: 'vc',
    description: 'Deep-tech venture fund investing in space, defense, and frontier technology companies.',
    website: 'https://explorer1fund.com',
    headquarters: 'Los Angeles, CA',
    foundedYear: 2019,
    investmentStage: ['series_a', 'series_b'],
    sectorFocus: ['launch', 'satellite', 'in_space'],
    portfolioCount: 3,
    notableDeals: ['Ursa Major', 'CesiumAstro'],
  },
  {
    name: 'Bain Capital',
    type: 'pe',
  ...
  },
  {
    name: 'ICONIQ Growth',
    type: 'pe',
    description: 'Technology growth equity firm managing capital for notable tech founders and families.',
...
const FUNDING_ROUNDS: FundingRoundData[] = [
  ...
  },
  {
    ...
    roundType: 'equity',
    leadInvestor: 'DCVC (Data Collective)',
    investors: ['DCVC (Data Collective)', 'Y Combinator'],
    source: 'Crunchbase',
  },
  ...
  // ── Virgin Orbit (bankrupt) ──
  {
    ...
    investors: ['NextGen Acquisition Corp II', 'Boeing Ventures'],
    source: 'SEC Filing',
  },
  ...
  // ── Hermeus ──
  {
    ...
    roundType: 'equity',
    leadInvestor: 'Khosla Ventures',
    investors: ['Khosla Ventures', 'Lux Capital', 'Sam Altman'],
    source: 'Press Release',
  },
  ...
  // ── Wisk Aero ──
  {
    ...
    seriesLabel: 'Series B',
    roundType: 'equity',
    leadInvestor: 'Boeing Ventures',
    investors: ['Boeing Ventures'],
    source: 'Press Release',
  },
  ...
  // SparkCognition
  {
    ...
    investors: ['March Capital', 'Boeing Ventures'],
    source: 'Press Release',
  },
