...
const LISTINGS: ListingData[] = [
  ...
  {
    companySlug: 'spacex',
    name: 'Starlink IoT Satellite Connectivity',
    description: 'Low-cost satellite IoT connectivity for remote sensors, trackers, and devices via the Starlink network. Provides bidirectional data relay for agricultural sensors, wildlife trackers, maritime devices, and industrial IoT in areas beyond cellular coverage. Built on technology from SpaceX\'s Swarm acquisition.',
    category: 'satellite',
    subcategory: 'iot',
    pricingType: 'per_unit',
    priceMin: 5,
    ...
    leadTime: '2 weeks',
    coverageArea: 'Global',
    specifications: { messageSize: '192 bytes', latency: 'Near real-time', network: 'Starlink / Swarm' },
  },
  {
  ...
  },
  {
    ...
    description: 'Lightweight composite structures, thermal management systems, and spacecraft structural components. Advanced composite materials with flight heritage for demanding thermal environments. Rocket Lab\'s vertically integrated manufacturing produces structures for Electron, Neutron, and third-party programs.',
    category: 'manufacturing',
  ...
  },
  {
    ...
    description: 'Microgravity manufacturing of high-purity ZBLAN fiber optics via Redwire\'s Made In Space heritage. Fibers produced in space have 10-100x lower signal loss than Earth-manufactured equivalents, enabling next-generation telecommunications and sensing applications.',
    category: 'rnd',
