...
const TIER_2: CompanyData[] = [
  ...
  // 36. True Anomaly
  {
    ...
    keyPersonnel: [
      { name: 'Evan Rogers', title: 'Co-Founder & CEO', role: 'founder', bio: 'Former US Air Force officer and SpaceX engineer. Co-founded True Anomaly to address space security.', previousCompanies: ['US Air Force', 'SpaceX'] },
    ],
    events: [
  ...
  // 61. General Atomics
  {
    ...
    ceo: 'Neal Blue (deceased Sept 2023; leadership transition)',
    isPublic: false,
    status: 'active',
    sector: 'defense-aerospace',
    ...
    keyPersonnel: [
      { name: 'Neal Blue', title: 'Chairman & CEO (deceased Sept 2023)', role: 'executive', bio: 'Chairman and CEO of General Atomics for over four decades. Passed away September 2023.' },
    ],
    events: [
  ...
  // 62. Ball Aerospace
  {
    ...
    keyPersonnel: [
      { name: 'Makenzie Lystrup', title: 'President', role: 'executive', bio: 'First woman to lead Ball Aerospace. Oversees spacecraft and instrument programs within BAE Systems.' },
    ],
    events: [
...
const TIER_3: CompanyData[] = [
  ...
  },
  {
    ...
    ceo: 'Curt Blake',
    parentCompany: 'Firefly Aerospace',
    sector: 'launch-services',
